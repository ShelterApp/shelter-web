...
!(function() {
  ...
  window.Framework7 = function(a) {
    ...
    function n() {
      ...
      if (
        ...
        i > t && a.trigger("infinite");
      else if (t + r >= n - i) {
        if (s.length > 0 && ((e = s[0].f7VirtualList), e && !e.reachEnd))
          return;
        a.trigger("infinite");
      }
    }
    ...
    var p = function(e, a) {
      ...
      i.params.pushState &&
        ...
        (f
          ? (u = f)
          : u.indexOf(m) >= 0 && u.indexOf(m + "#") < 0 && (u = u.split(m)[0]));
      var h, g;
      s.activePage ||
        ...
        s.params.domCache && h
          ? ((s.url =
              l.attr("data-url") || s.params.url || "#" + h.attr("data-page")),
        ...
        g &&
          ...
          s.params.domCache &&
            ...
            (g.navbarInnerContainer =
              s.initialNavbars[s.initialPages.indexOf(g.container)]),
          (s.activePage = g),
          (h[0].f7PageData = g)),
      ...
      if (
        ((s.handleTouchStart = function(e) {
          B &&
            ...
            (C = new Date().getTime()),
            (P = s.params.dynamicNavbar && l.find(".navbar-inner").length > 1));
        }),
        (s.handleTouchMove = function(e) {
          if (I) {
            ...
            if (
              ("undefined" == typeof v &&
                (v = !!(v || Math.abs(t - E.y) > Math.abs(a - E.x))),
            ...
            if (!O) {
              ...
              p.length > 0 &&
                (!i.rtl &&
                  p.find(".swipeout-actions-left").length > 0 &&
                  (n = !0),
                i.rtl &&
                  p.find(".swipeout-actions-right").length > 0 &&
                  (n = !0)),
                (D = r.is(".page") ? r : r.parents(".page")),
                D.hasClass("no-swipeback") && (n = !0),
                (L = l.find(".page-on-left:not(.cached)"));
              ...
              if (
                ((d = i.rtl
                  ...
                  : E.x - l.offset().left > s.params.swipeBackPageActiveArea),
                d && (n = !0),
                (0 === L.length || 0 === D.length) && (n = !0),
                n)
              )
                return void (I = !1);
              s.params.swipeBackPageAnimateShadow &&
                !i.device.android &&
                ((S = D.find(".swipeback-page-shadow")),
                0 === S.length &&
                  ((S = o('<div class="swipeback-page-shadow"></div>')),
                  D.append(S))),
                P &&
                  ((N = l.find(".navbar-on-center:not(.cached)")),
                  (z = l.find(".navbar-on-left:not(.cached)")),
                  (y = N.find(".left, .center, .right, .subnavbar, .fading")),
                  (x = z.find(".left, .center, .right, .subnavbar, .fading")),
                  i.params.animateNavBackIcon &&
                    ((T = N.find(".left.sliding .back .icon")),
                    (k = z.find(".left.sliding .back .icon")))),
              ...
              for (g = 0; g < y.length; g++)
                if (
                  ...
                  1 === i.device.pixelRatio && (C = Math.round(C)),
                    ...
                    i.params.animateNavBackIcon &&
                      M[0].className.indexOf("left") >= 0 &&
                      T.length > 0 &&
                      T.transform("translate3d(" + -C + "px,0,0)");
                }
                ...
                if (
                  ...
                  1 === i.device.pixelRatio && (B = Math.round(B)),
                    ...
                    i.params.animateNavBackIcon &&
                      M[0].className.indexOf("left") >= 0 &&
                      k.length > 0 &&
                      k.transform("translate3d(" + -B + "px,0,0)");
                }
            }
          }
        }),
        (s.handleTouchEnd = function(e) {
          ...
          var a = new Date().getTime() - C,
            t = !1;
          ((300 > a && w > 10) || (a >= 300 && w > b / 2)) &&
            (D.removeClass("page-on-center").addClass("page-on-right"),
            L.removeClass("page-on-left").addClass("page-on-center"),
            P &&
              (N.removeClass("navbar-on-center").addClass("navbar-on-right"),
              z.removeClass("navbar-on-left").addClass("navbar-on-center")),
            (t = !0)),
            o([D[0], L[0]])
              .transform("")
              .css({ opacity: "", boxShadow: "" })
                ...
                .each(function() {
                  ...
                  a.transform("translate3d(" + e + "px,0,0)"),
                    i.params.animateNavBackIcon &&
                      a.hasClass("left") &&
                      T.length > 0 &&
                      T.addClass("page-transitioning").transform(
          ...
          D.transitionEnd(function() {
            o([D[0], L[0]]).removeClass("page-transitioning"),
              P &&
                (y.removeClass("page-transitioning").css({ opacity: "" }),
                x.removeClass("page-transitioning").css({ opacity: "" }),
                T && T.length > 0 && T.removeClass("page-transitioning"),
                k && k.length > 0 && k.removeClass("page-transitioning")),
              (B = !0),
              (s.allowPageChange = !0),
              t
                ? (i.params.pushState && s.main && history.back(),
        ...
        s.params.swipeBackPage && !i.params.material && s.attachEvents(),
        i.views.push(s),
        s.main && (i.mainView = s),
        (s.router = {
          load: function(e) {
        ...
        var A,
          H = c.split(m)[1];
        f
          ? (A = c.split(i.params.pushStateRoot + m)[1])
          : m && c.indexOf(m) >= 0 && c.indexOf(m + "#") < 0 && (A = H);
        ...
        A
          ? A.indexOf("#") >= 0 &&
            ...
            : A.indexOf("#") >= 0 &&
              s.params.domCache &&
              s.initialPagesUrl.indexOf(A) >= 0
            ? i.router.load(s, {
                pageName: A.replace("#", ""),
                animatePages: R,
                pushState: !1
              })
            : i.router.load(s, { url: A, animatePages: R, pushState: !1 })
          : s.params.domCache &&
            c.indexOf(m + "#") >= 0 &&
    ...
    (i.addView = function(e, a) {
      ...
      (i.navbarInitCallback = function(e, a, t, n) {
        if (
          ...
          !n.f7NavbarInitialized || !e || e.params.domCache)
        ) {
        ...
        0 !== t.length &&
          ...
          e.find(".navbar-inner").each(function() {
            ...
            if (
              (o(r).attr("data-page") &&
                (n = t.find(
                  '.page[data-page="' + o(r).attr("data-page") + '"]'
                )[0]),
              !n)
            ) {
              var s = t.find(".page");
              1 === s.length
                ...
                : t.find(".page").each(function() {
                    this.f7PageData &&
                      this.f7PageData.navbarInnerContainer === r &&
                      (n = this);
                  });
            }
          ...
          a.each(function() {
            ...
            if (!e.hasClass("cached")) {
              ...
              s.hasClass("sliding") &&
                ...
                (s[0].f7NavbarRightOffset = (h - a - t - m) * b),
                g &&
                  s.transform(
                    "translate3d(" + s[0].f7NavbarLeftOffset + "px, 0, 0)"
                  )),
                !p &&
                  n.hasClass("sliding") &&
                  (i.rtl
                    ...
                    : ((n[0].f7NavbarLeftOffset = -c),
                      (n[0].f7NavbarRightOffset = (h - n[0].offsetWidth) / 2)),
                  g &&
                    n.transform(
                      "translate3d(" + n[0].f7NavbarLeftOffset + "px, 0, 0)"
                    )),
                !d &&
                  r.hasClass("sliding") &&
                  (i.rtl
                    ...
                    : ((r[0].f7NavbarLeftOffset = -(h - r[0].offsetWidth) / 2),
                      (r[0].f7NavbarRightOffset = u)),
                  g &&
                    r.transform(
                      "translate3d(" + r[0].f7NavbarLeftOffset + "px, 0, 0)"
                    )),
                l.length &&
                  l.hasClass("sliding") &&
                  ((l[0].f7NavbarLeftOffset = i.rtl
                    ? l[0].offsetWidth
                    : -l[0].offsetWidth),
                  (l[0].f7NavbarRightOffset = -l[0].f7NavbarLeftOffset));
              var w = t;
    ...
    var d = function(e, a) {
      ...
      a = a || {};
      for (var s in r)
        ("undefined" == typeof a[s] || null === a[s]) && (a[s] = r[s]);
      var l = this;
      (l.material = i.params.material),
        ...
        (l.container = e),
        (l.active = !1),
        (l.input = l.params.input
          ? o(l.params.input)
          : l.container.find('input[type="search"]')),
        (l.clearButton = l.params.clearButton
          ? o(l.params.clearButton)
          : l.container.find(".searchbar-clear")),
        (l.cancelButton = l.params.cancelButton
          ? o(l.params.cancelButton)
          : l.container.find(".searchbar-cancel")),
        ...
        l.params.overlay
          ...
          : (l.overlay =
              l.pageContainer.length > 0
                ? l.pageContainer.find(".searchbar-overlay")
                : o(".searchbar-overlay")),
        l.params.found
          ? (l.found = o(l.params.found))
          : (l.found =
              l.pageContainer.length > 0
                ? l.pageContainer.find(".searchbar-found")
                : o(".searchbar-found")),
        l.params.notFound
          ? (l.notFound = o(l.params.notFound))
          : (l.notFound =
              l.pageContainer.length > 0
                ? l.pageContainer.find(".searchbar-not-found")
      ...
      for (
        ...
        for (var u = p[c].letters, m = 0; m < u.length; m++)
          d[u[m]] = p[c].base;
      var f = i.rtl ? "margin-left" : "margin-right",
        h = !1;
      (l.setCancelButtonMargin = function() {
        l.cancelButton.transition(0).show(),
          l.cancelButton.css(f, -l.cancelButton[0].offsetWidth + "px");
        ...
        (l.enable = function() {
          function e() {
            (!l.searchList.length && !l.params.customSearch) ||
              l.container.hasClass("searchbar-active") ||
              l.overlay.addClass("searchbar-overlay-active"),
              l.container.addClass("searchbar-active"),
              l.cancelButton.length > 0 &&
                !l.material &&
                (h || l.setCancelButtonMargin(), l.cancelButton.css(f, "0px")),
              l.triggerEvent("enableSearch", "onEnable"),
              (l.active = !0);
          }
          i.device.ios && !i.params.material
            ? setTimeout(function() {
                e();
              }, 400)
            : e();
        ...
        (l.disable = function() {
          ...
          l.input.val("").trigger("change"),
            ...
            l.cancelButton.length > 0 &&
              ...
              l.cancelButton.css(f, -l.cancelButton[0].offsetWidth + "px"),
            (l.searchList.length || l.params.customSearch) &&
              l.overlay.removeClass("searchbar-overlay-active"),
            i.device.ios
              ? setTimeout(function() {
                  e();
                }, 400)
        ...
        (l.clear = function(e) {
          return !l.query && e && o(e.target).hasClass("searchbar-clear")
            ? void l.disable()
            : (l.input
                .val("")
                .trigger("change")
                .focus(),
              void l.triggerEvent("clearSearch", "onClear"));
        }),
        (l.handleInput = function() {
          setTimeout(function() {
            var e = l.input.val().trim();
            (l.searchList.length > 0 || l.params.customSearch) &&
              (l.params.searchIn || l.isVirtualList) &&
              l.search(e, !0);
          }, 0);
        });
      var g,
        v = "";
      return (
        (l.search = function(e, a) {
          if (e.trim() !== v) {
            if (
              ((v = e.trim()),
              a || (l.active || l.enable(), a || l.input.val(e)),
              (l.query = l.value = e),
              0 === e.length
                ? (l.container.removeClass("searchbar-not-empty"),
                  l.searchList.length &&
                    l.container.hasClass("searchbar-active") &&
                    l.overlay.addClass("searchbar-overlay-active"))
                : (l.container.addClass("searchbar-not-empty"),
                  l.searchList.length &&
                    l.container.hasClass("searchbar-active") &&
                    l.overlay.removeClass("searchbar-overlay-active")),
              l.params.customSearch)
            )
              return void l.triggerEvent("search", "onSearch", { query: e });
            var n = [];
            if (l.isVirtualList) {
              if (((g = l.searchList[0].f7VirtualList), "" === e.trim()))
                return g.resetFilter(), l.notFound.hide(), void l.found.show();
              if (g.params.searchAll) n = g.params.searchAll(e, g.items) || [];
              else if (g.params.searchByItem)
                for (var r = 0; r < g.items.length; r++)
                  g.params.searchByItem(e, r, g.params.items[r]) && n.push(r);
            } else {
              var i;
              (i = l.params.removeDiacritics
                ? t(e.trim().toLowerCase()).split(" ")
                : e
                    .trim()
                    .toLowerCase()
                    .split(" ")),
                l.searchList
                  ...
                  .each(function(e, a) {
                    ...
                    a.find(l.params.searchIn).each(function() {
                      ...
                      (r = r.join(" "));
                    for (var s = 0, p = 0; p < i.length; p++)
                      r.indexOf(i[p]) >= 0 && s++;
                    s === i.length || (l.params.ignore && a.is(l.params.ignore))
                      ? n.push(a[0])
                      : a.addClass("hidden-by-searchbar");
                  }),
                l.params.hideDividers &&
                  l.searchList
                    .find(".item-divider, .list-group-title")
                    .each(function() {
                      for (
                        var e = o(this), a = e.nextAll("li"), t = !0, n = 0;
                        n < a.length;
                        n++
                      ) {
                        var r = o(a[n]);
                        if (
                          r.hasClass("list-group-title") ||
                      ...
                      t && !i
                        ? e.addClass("hidden-by-searchbar")
                        : e.removeClass("hidden-by-searchbar");
                    }),
                l.params.hideGroups &&
                  l.searchList.find(".list-group").each(function() {
                    var e = o(this),
            ...
            l.triggerEvent("search", "onSearch", { query: e, foundItems: n }),
              0 === n.length
                ? (l.notFound.show(), l.found.hide())
                : (l.notFound.hide(), l.found.show()),
              l.isVirtualList && g.filterItems(n);
          }
        }),
      ...
      (i.initSearchbar = function(e) {
        ...
        if (0 !== t.length && t.hasClass("searchbar-init")) {
          ...
          e.hasClass("page")
            ...
            : e.hasClass("navbar-inner") && e.once("navbarBeforeRemove", a);
        }
      });
    var c = function(e, a) {
      function t(e) {
            ...
            (i.sizeTextarea = function() {
              ...
              if (t + a > e) {
                var n = t + a,
                  ...
                  s =
                    i.params.maxHeight ||
                    i.container.parents(".view")[0].offsetHeight - 88;
                r > s &&
                  ((r = parseInt(s, 10)),
                  (n = r - i.initialBarHeight + i.initialAreaHeight)),
                  i.textarea.css("height", n + "px"),
                  i.container.css("height", r + "px");
                var o =
                  i.pageContent[0].scrollTop ===
                  i.pageContent[0].scrollHeight - i.pageContent[0].offsetHeight;
                i.pageContent.length > 0 &&
                  (i.pageContent.css("padding-bottom", r + "px"),
                  0 === i.pageContent.find(".messages-new-first").length &&
                    o &&
      ...
      (i.get = function(e, a, t, n) {
        ...
        if (
          ...
          for (var s = 0; s < i.cache.length; s++)
            if (
              i.cache[s].url === r &&
              new Date().getTime() - i.cache[s].time < i.params.cacheDuration
            )
        ...
        return (
          (i.xhr = o.ajax({
            ...
            complete: function(e) {
              (e.status >= 200 && e.status < 300) || 0 === e.status
                ? (i.params.cache &&
                    (i.removeFromCache(r),
                    i.cache.push({
                      url: r,
    ...
    for (
      var u = "beforeInit init reinit beforeAnimation afterAnimation back afterBack beforeRemove".split(
          " "
        ),
        m = 0;
      m < u.length;
    ...
    (i.triggerPageCallbacks = function(e, a, t) {
        ...
        if (!t.f7PageInitialized || !e || e.params.domCache) {
          ...
          if (
            (a.fromPage &&
              ...
              (a.fromPage.navbarInnerContainer = a.oldNavbarInnerContainer),
            t.f7PageInitialized &&
              ((e && e.params.domCache) ||
                (!e &&
                  o(t).parents(
            ...
            return (
              ...
              i.params.onPageReinit && i.params.onPageReinit(i, r),
          ...
          (t.f7PageInitialized = !0),
            ...
            !e ||
              a.preloadOnly ||
              a.reloadPrevious ||
              (o(e.container).attr("data-page", r.name), (e.activePage = r)),
            i.pluginHook("pageBeforeInit", r),
            i.params.onPageBeforeInit && i.params.onPageBeforeInit(i, r),
            i.triggerPageCallbacks("beforeInit", r.name, r),
            o(r.container).trigger("pageBeforeInit", { page: r }),
            i.initPage(t),
      ...
      (i.pageRemoveCallback = function(e, a, t) {
        ...
        i.pluginHook("pageBeforeRemove", r),
          ...
          o(r.container).trigger("pageBeforeRemove", { page: r });
      }),
      ...
      (i.pageAnimCallback = function(e, a, t) {
        ...
        if (
          ...
          "after" === e &&
            ...
            o(l.container).trigger("pageAfterAnimation", { page: l })),
          "before" === e)
        ) {
            ...
            d.hasClass("no-tabbar") ||
              ...
              0 === c.length &&
                (c = o(a.container)
                  ...
                  .find(".tabbar")),
              i.showToolbar(c)),
            p.removeClass("no-navbar-by-scroll no-toolbar-by-scroll"),
            i.pluginHook("pageBeforeAnimation", l),
            i.params.onPageBeforeAnimation &&
              i.params.onPageBeforeAnimation(i, l),
            i.triggerPageCallbacks("beforeAnimation", l.name, l),
            o(l.container).trigger("pageBeforeAnimation", { page: l });
        }
      }),
      (i.initPage = function(e) {
        (e = o(e)),
          0 !== e.length &&
            (i.sizeNavbars &&
              i.sizeNavbars(e.parents("." + i.params.viewClass)[0]),
            ...
            i.initPageResizableTextarea && i.initPageResizableTextarea(e),
            i.params.material &&
      ...
      (i.router = {
        ...
        findElement: function(e, a, t, n) {
          ...
          return (
            r.length > 1 &&
              ...
              r.length > 1 &&
                (r = a.find("." + i.params.viewMainClass + " " + e))),
            1 === r.length
              ? r
              : (n || (r = i.router.findElement(e, a, t, !0)),
                r && 1 === r.length ? r : void 0)
          );
        },
        animatePages: function(e, a, t, n) {
          var r = "page-on-center page-on-right page-on-left";
          "to-left" === t &&
            (e.removeClass(r).addClass("page-from-center-to-left"),
            a.removeClass(r).addClass("page-from-right-to-center")),
            "to-right" === t &&
              (e.removeClass(r).addClass("page-from-left-to-center"),
              a.removeClass(r).addClass("page-from-center-to-right"));
        },
          ...
          o(e)
            ...
            .each(function() {
              ...
              i.params.animateNavBackIcon &&
                ...
                "left" === t &&
                  e.hasClass("center") &&
                  o(a).find(".left .back .icon ~ span").length > 0 &&
                  (n += o(a).find(".left .back span")[0].offsetLeft)),
        ...
        animateNavbars: function(e, a, t, n) {
          ...
          "to-left" === t &&
            (a.removeClass(r).addClass("navbar-from-right-to-center"),
            a.find(".sliding").each(function() {
              ...
              e.transform("translate3d(0px,0,0)"),
                i.params.animateNavBackIcon &&
                  e.hasClass("left") &&
                  e.find(".back .icon").length > 0 &&
                  e.find(".back .icon").transform("translate3d(0px,0,0)");
            }),
            e.removeClass(r).addClass("navbar-from-center-to-left"),
            e.find(".sliding").each(function() {
              var e,
                t = o(this);
              i.params.animateNavBackIcon &&
                (t.hasClass("center") &&
                  a.find(".sliding.left .back .icon").length > 0 &&
                  ((e = a.find(".sliding.left .back span")),
                  e.length > 0 && (this.f7NavbarLeftOffset += e[0].offsetLeft)),
                t.hasClass("left") &&
            ...
            "to-right" === t &&
              (e.removeClass(r).addClass("navbar-from-left-to-center"),
              e.find(".sliding").each(function() {
                var e = o(this);
                e.transform("translate3d(0px,0,0)"),
                  i.params.animateNavBackIcon &&
              ...
              a.removeClass(r).addClass("navbar-from-center-to-right"),
              a.find(".sliding").each(function() {
                var e = o(this);
                i.params.animateNavBackIcon &&
                  e.hasClass("left") &&
        ...
        preroute: function(e, a) {
          return (
            ...
            (i.params.preroute && i.params.preroute(e, a) === !1) ||
            (e && e.params.preroute && e.params.preroute(e, a) === !1)
              ? !0
              : !1
          );
        },
        template7Render: function(e, a) {
          ...
          if (
            ...
            if (c)
              if (c.indexOf(".") >= 0) {
                for (
                  var m = c.split("."), f = l.data[m[0]], h = 1;
                  h < m.length;
                  h++
                )
                  m[h] && (f = f[m[h]]);
      ...
      (i.router._load = function(e, a) {
          ...
          (e.allowPageChange = !0),
            ...
            e.params.swipeBackPage ||
              ...
              (e.params.domCache
                ...
                : (0 !== f.indexOf("#") ||
                    0 !== n.attr("data-page").indexOf("smart-select-")) &&
          ...
          if (s.length > 1) {
            for (l = 0; l < s.length - 2; l++)
              e.params.domCache
                ...
                : (i.pageRemoveCallback(e, s[l], "left"), o(s[l]).remove());
            e.params.domCache
              ? o(s[l]).addClass("cached")
              : (i.pageRemoveCallback(e, s[l], "left"), o(s[l]).remove());
          }
        ...
        if (
          (e.params.domCache && n.removeClass("cached"), e.params.dynamicNavbar)
        )
          if (
            ((u = !0),
            (d = b
        ...
        if (
          (u &&
            (d.addClass(a.reload ? "navbar-on-" + m : "navbar-on-right"),
            e.params.domCache && d.removeClass("cached"),
          ...
          (f = x
            ? "#" +
              i.params.dynamicPageUrl
                .replace(/{{name}}/g, P)
                .replace(/{{index}}/g, e.history.length - (a.reload ? 1 : 0))
            : "#" + P),
          ...
          T &&
            (x || b
              ? x && h
                ...
                : b &&
                  history[M](
                    { pageName: b, url: f, viewIndex: i.views.indexOf(e) },
                    "",
                    S + i.params.pushStateSeparator + f
                  )
              : history[M](
        ...
        if (((e.url = f), a.reload)) {
          ...
          I &&
            ...
            I in e.contentCache &&
            I !== f &&
            -1 === e.history.indexOf(I) &&
            ((e.contentCache[I] = null), delete e.contentCache[I]),
        ...
        if (e.params.uniqueHistory) {
          ...
          if (e.params.uniqueHistoryIgnoreGetParameters)
            for (E = [], D = f.split("?")[0], l = 0; l < e.history.length; l++)
              E.push(e.history[l].split("?")[0]);
          E.indexOf(D) !== E.lastIndexOf(D) &&
            ((e.history = e.history.slice(0, E.indexOf(D))),
            e.history.push(f),
            (O = !0));
        }
        if (
          (a.reloadPrevious
            ? ((r = r.prev(".page")),
              n.insertBefore(r),
              u && ((p = p.prev(".navbar-inner")), d.insertAfter(p)))
          ...
          return (e.allowPageChange = !0), void (O && e.refreshPreviousPage());
        ...
        i.pageAnimCallback("before", e, {
          ...
          y
            ...
            : (u && d.find(".sliding, .sliding .back .icon").transform(""),
              t());
      }),
      (i.router.load = function(e, a) {
        ...
        s &&
          s.indexOf("?") > 0 &&
          ((a.query = o.parseUrlQuery(s)), (a.pageName = s = s.split("?")[0]));
        var l = a.template;
        return (
          e.params.reloadPages === !0 && (a.reload = !0),
          e.allowPageChange &&
          (!n || e.url !== n || a.reload || e.params.allowDuplicateUrls)
            ? ((e.allowPageChange = !1),
              i.xhr &&
                e.xhr &&
                e.xhr === i.xhr &&
              ...
              r || s
                ...
                : a.url && "#" !== a.url
                ? void i.get(a.url, e, a.ignoreCache, function(a, n) {
      ...
      (i.router._back = function(e, a) {
        ...
        function n() {
          i.pageBackCallback("before", e, {
            ...
            w
              ...
              : (f && c.find(".sliding, .sliding .back .icon").transform(""),
                t());
        }
        function r() {
          if (
        ...
        function s() {
          ...
          if (
            ...
            f &&
              ((u = k.find(".navbar")),
              (m = k.find(".navbar-inner:not(.cached)")),
            ...
            if (
              ((t = o(S[S.length - 2])),
              f && (r = o((t[0] && t[0].f7RelatedNavbar) || m[m.length - 2])),
              e.params.domCache && e.initialPages.indexOf(t[0]) >= 0)
            )
              ...
              t.length
                ? (i.pageRemoveCallback(e, t[0], "right"),
                  s && i.navbarRemoveCallback(e, t[0], u[0], r[0]),
                  t.remove(),
                  s && r.remove())
                : s &&
                  (i.navbarRemoveCallback(e, t[0], u[0], r[0]), r.remove());
            }
            (S = P.children(".page:not(.cached)")),
              f && (m = k.find(".navbar-inner:not(.cached)")),
              e.history.indexOf(h) >= 0
                ? (e.history = e.history.slice(0, e.history.indexOf(h) + 2))
          ...
          if (
            ...
            e.params.domCache &&
              l[0] === p[0] &&
              ((l = P.children(".page.page-on-center")),
              0 === l.length &&
                e.activePage &&
            ...
            f &&
              ...
              e.params.domCache &&
                ...
                0 === d.length &&
                  (d = u.children(
                    '.navbar-inner[data-page="' + l.attr("data-page") + '"]'
                  ))),
            ...
            f && i.navbarInitCallback(e, p[0], u[0], c[0], h, "right"),
            f &&
        ...
        return (
          ...
          S.length > 1 && !x
            ...
            ? (h && h === e.url) ||
              ...
              : T && e.params.domCache
              ? (T && (h = "#" + T),
                (p = o(k).find('.page[data-page="' + T + '"]')),
                p[0].f7PageData &&
                  p[0].f7PageData.url &&
                  (h = p[0].f7PageData.url),
                e.params.dynamicNavbar &&
                  ((c = o(k).find('.navbar-inner[data-page="' + T + '"]')),
                  0 === c.length &&
                    p[0].f7RelatedNavbar &&
                    (c = o(p[0].f7RelatedNavbar)),
                  0 === c.length &&
                    p[0].f7PageData &&
                    (c = o(p[0].f7PageData.navbarInnerContainer))),
                void s())
              : void (e.allowPageChange = !0)
            : (C || ((e.url = e.history[e.history.length - 2]), (h = e.url)),
              g
                ? (r(), void s())
                : T
                ? ((p = o(k).find('.page[data-page="' + T + '"]')),
      ...
      (i.router.back = function(e, a) {
        ...
        if (l) {
          ...
          if (n)
            return void i.get(a.url, e, a.ignoreCache, function(a, n) {
              return n ? void (e.allowPageChange = !0) : void t(a);
            });
        } else {
          if (((n = a.url = e.history[e.history.length - 2]), !n))
            return void (e.allowPageChange = !0);
      ...
      (i.router.afterBack = function(e, a, t) {
        (a = o(a)),
          ...
          e.params.domCache && e.initialPages.indexOf(a[0]) >= 0
            ? a.removeClass("page-from-center-to-right").addClass("cached")
            : (i.pageRemoveCallback(e, a[0], "right"), a.remove()),
          t
        ...
        if (e.params.dynamicNavbar) {
          ...
          e.params.domCache && e.initialNavbars.indexOf(l[0]) >= 0
            ? l.removeClass("navbar-from-center-to-right").addClass("cached")
            : (i.navbarRemoveCallback(e, a[0], void 0, l[0]), l.remove()),
            (n = o(s[0])
            ...
            o(e.container)
              ...
              .each(function() {
                ...
                t &&
                  ...
                  a[0].f7RelatedNavbar &&
                    e.params.dynamicNavbar &&
                    o(a[0].f7RelatedNavbar).remove());
              }),
          !e.params.domCache &&
            r &&
            r.indexOf("#") > -1 &&
            r in e.contentCache &&
            -1 === e.history.indexOf(r) &&
          ...
          if (e.params.domCache && e.history.length > 1) {
            ...
            c && e.pagesCache[c]
              ? ((p = o(e.container).find(
                ...
                n &&
                  ((d = o(e.container).find(
                    '.navbar-inner[data-page="' + e.pagesCache[c] + '"]'
                  )),
                  (d && 0 !== d.length) || (d = n.prev(".navbar-inner.cached")),
                  d.next(".navbar-inner")[0] !== n[0] && d.insertBefore(n)))
    ...
    (i.modalStack = []),
      ...
      (i.modal = function(e) {
        ...
        if (i.params.modalTemplate)
          i._compiledTemplates.modal ||
            (i._compiledTemplates.modal = l.compile(i.params.modalTemplate)),
          ...
          if (e.buttons && e.buttons.length > 0)
            for (var n = 0; n < e.buttons.length; n++)
              t +=
                ...
                (e.buttons[n].bold ? " modal-button-bold" : "") +
                '">' +
                e.buttons[n].text +
                "</span>";
          var r = e.title
          ...
          m.find(".modal-button").each(function(a, t) {
            o(t).on("click", function(t) {
              e.buttons[a].close !== !1 && i.closeModal(m),
                e.buttons[a].onClick && e.buttons[a].onClick(m, t),
      ...
      (i.alert = function(e, a, t) {
        return (
          "function" == typeof a && ((t = arguments[1]), (a = void 0)),
          i.modal({
            text: e || "",
        ...
        return (
          ...
          i.modal({
            ...
            buttons: [
              ...
              { text: i.params.modalButtonOk, bold: !0, onClick: t }
            ]
          })
        );
      }),
      ...
      (i.actions = function(e, a) {
        ...
        if (s) {
          ...
          i._compiledTemplates.actionsToPopover ||
            (i._compiledTemplates.actionsToPopover = l.compile(d));
      ...
      (i.popover = function(e, a, t) {
          ...
          if (s) {
            if (
              ...
              a
                ...
                .transform("translate3d(" + C + "px, " + y + "px,0)")
                .transitionEnd(function(e) {
                  a.hasClass("floating-button-to-popover-in") &&
                    a
            ...
            l + p < u.top
              ...
              "top" === w || "bottom" === w
                ? ((v = d / 2 + u.left - i / 2),
                  ...
                  (b -= v),
                  (n = i / 2 - p + b),
                  (n = Math.max(Math.min(n, i - 2 * p - 13), 13)),
                  t.css({ left: n + "px" }))
                : "middle" === w &&
                  ((v = u.left - i - p),
                  t.addClass("on-right"),
                  (5 > v || v + i > h) &&
                    (5 > v && (v = u.left + d + p),
                    v + i > h && (v = h - i - 5),
                    t.removeClass("on-right").addClass("on-left")),
                  (r = l / 2 - p + b),
                  (r = Math.max(Math.min(r, l - 2 * p - 13), 13)),
                  t.css({ top: r + "px" }));
        ...
        0 !== e.find(".popover-angle").length ||
          i.params.material ||
          e.append('<div class="popover-angle"></div>'),
          e.show();
      ...
      (i.popup = function(e, a) {
        ...
        return (
          (e = o(e)), 0 === e.length ? !1 : (e.show(), i.openModal(e), e[0])
        );
      }),
      (i.pickerModal = function(e, a) {
        ...
        return (
          ...
          0 === e.length
            ? !1
            : (o(".picker-modal.modal-in:not(.modal-out)").length > 0 &&
                !e.hasClass("modal-in") &&
                i.closeModal(".picker-modal.modal-in:not(.modal-out)"),
              e.show(),
              i.openModal(e),
              e[0])
        );
      ...
      (i.loginScreen = function(e) {
        return (
          ...
          0 === e.length
            ? !1
            : (o(".login-screen.modal-in:not(.modal-out)").length > 0 &&
                !e.hasClass("modal-in") &&
                i.closeModal(".login-screen.modal-in:not(.modal-out)"),
              e.show(),
              i.openModal(e),
              e[0])
        );
      ...
      (i.openModal = function(e) {
        ...
        if (!0 !== e.data("f7-modal-shown")) {
          ...
          a &&
            (e.show(),
            e.css({ marginTop: -Math.round(e.outerHeight() / 2) + "px" }));
          var s;
          n ||
            r ||
            (0 !== o(".modal-overlay").length ||
              t ||
              o("body").append('<div class="modal-overlay"></div>'),
            0 === o(".popup-overlay").length &&
              t &&
              o("body").append('<div class="popup-overlay"></div>'),
            (s = o(t ? ".popup-overlay" : ".modal-overlay"))),
            i.params.material &&
              r &&
              e.hasClass("picker-calendar") &&
              (0 !== o(".picker-modal-overlay").length ||
                t ||
                o("body").append('<div class="picker-modal-overlay"></div>'),
              (s = o(".picker-modal-overlay")));
          e[0].clientLeft;
          return (
            e.trigger("open"),
      ...
      (i.closeModal = function(e) {
        if (
          ((e = o(e || ".modal-in")), "undefined" == typeof e || 0 !== e.length)
        ) {
          var a,
            t = e.hasClass("modal"),
          ...
          return (
            r
              ? (a = o(".popup-overlay"))
              : l && i.params.material
              ? (a = o(".picker-modal-overlay"))
              : l || (a = o(".modal-overlay")),
            r
              ? e.length === o(".popup.modal-in").length &&
                a.removeClass("modal-overlay-visible")
              : a && a.length > 0 && a.removeClass("modal-overlay-visible"),
            e.trigger("close"),
            l &&
            ...
            !n || i.params.material
              ? (e
                  ...
                  .transitionEnd(function(a) {
                    ...
                    l && o("body").removeClass("picker-modal-closing"),
                      r || s || l || n
                        ? (e.removeClass("modal-out").hide(),
                          p && e.length > 0 && e.remove())
                        : e.remove();
                  }),
                t && i.params.modalStack && i.modalStackClearQueue())
              : (e
                  .removeClass("modal-in modal-out")
                  .trigger("closed")
                  .hide(),
                p && e.remove()),
            !0
      ...
      (i.setProgressbar = function(e, a, t) {
        if (((e = o(e || "body")), 0 !== e.length)) {
          ...
          var n;
          if (
            ((n = e.hasClass("progressbar") ? e : e.children(".progressbar")),
      ...
      (i.showProgressbar = function(e, a, t) {
        if (
          ("number" == typeof e &&
            ((e = "body"), (a = arguments[0]), (t = arguments[1])),
          a &&
            "string" == typeof a &&
            parseFloat(a) !== 1 * a &&
            ((t = a), (a = void 0)),
      ...
      (i.initPageProgressbar = function(e) {
        (e = o(e)),
          e.find(".progressbar").each(function() {
            var e = o(this);
            0 === e.children("span").length && e.append("<span></span>"),
      ...
      (i.openPanel = function(e) {
          ...
          r.transitionEnd(function(e) {
            o(e.target).is(r)
              ? (t.hasClass("active")
                  ? t.trigger("opened")
                  : t.trigger("closed"),
                i.params.material && o(".panel-overlay").css({ display: "" }),
                (i.allowPanelOpen = !0))
              : a();
          });
        }
        ...
        t.css({ display: "block" }).addClass("active"),
          t.trigger("open"),
          i.params.material && o(".panel-overlay").show(),
          t.find("." + i.params.viewClass).length > 0 &&
            i.sizeNavbars &&
            i.sizeNavbars(t.find("." + i.params.viewClass)[0]);
        var r =
          (t[0].clientLeft, "reveal" === n ? o("." + i.params.viewsClass) : t);
      ...
      (i.initSwipePanels = function() {
        function e(e) {
          if (
            ...
            if (
              ...
              (w.y =
                "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY),
              i.params.swipePanelCloseOpposite || i.params.swipePanelOnlyClose)
            ) {
            ...
            if (
              ...
              if (
                "right" === r &&
                w.x < window.innerWidth - i.params.swipePanelActiveArea
              )
                return;
            }
            (l = !1),
        ...
        function a(e) {
          if (s && !e.f7PreventPanelSwipe) {
            ...
            if (
              ("undefined" == typeof p &&
                (p = !!(p || Math.abs(t - w.y) > Math.abs(a - w.x))),
              p)
            )
              return void (s = !1);
            if (
              ...
              ("left" === r && "to-left" === v && !n.hasClass("active")) ||
                ("right" === r && "to-right" === v && !n.hasClass("active")))
            )
              return void (s = !1);
              ...
              return (
                300 > o &&
                  ("to-left" === v &&
                    ...
                    "left" === r && n.hasClass("active") && i.closePanel()),
                  "to-right" === v &&
                    ("left" === r && i.openPanel(r),
                    "right" === r && n.hasClass("active") && i.closePanel())),
                (s = !1),
                void (l = !1)
              );
            }
            l ||
              ((g = n.hasClass("panel-cover") ? "cover" : "reveal"),
              f || (n.show(), b.show()),
              (h = n[0].offsetWidth),
              n.transition(0),
            ...
            "right" === r && (y = -y),
              (c = a - w.x + y),
              "right" === r
                ? ((u = c - (f ? h : 0)), u > 0 && (u = 0), -h > u && (u = -h))
                : ((u = c + (f ? h : 0)), 0 > u && (u = 0), u > h && (u = h)),
              "reveal" === g
                ? (C.transform("translate3d(" + u + "px,0,0)").transition(0),
                  b.transform("translate3d(" + u + "px,0,0)").transition(0),
                  i.pluginHook(
                ...
                : (n.transform("translate3d(" + u + "px,0,0)").transition(0),
                  i.params.material &&
                    (b.transition(0),
                    (m = Math.abs(u / h)),
                    b.css({ opacity: m })),
      ...
      (i.initImagesLazyLoad = function(e) {
        ...
        function t() {
          (l = e.find(".lazy")),
            l.each(function(e, t) {
              (t = o(t)),
                t.parents(".tab:not(.active)").length > 0 || (n(t[0]) && a(t));
            });
        }
        function n(e) {
        ...
        0 !== r.container.length
          ? (r.params.autoLayout &&
            ...
            (r.layout = function() {
              r.container.hasClass("messages-auto-layout") ||
                ...
                r.container.find(".message").each(function() {
                  var e = o(this);
                  e.find(".message-text img").length > 0 &&
                ...
                r.container.find(".message").each(function() {
                  ...
                  0 === t.length
                    ? e.addClass("message-last message-with-tail")
                    : e.removeClass("message-last message-with-tail"),
                    0 === n.length
                    ...
                    n.length > 0 &&
                      ...
                      (n.addClass("message-last message-with-tail"),
                      e.addClass("message-first"));
                });
            }),
            ...
            (r.addMessages = function(e, a, t) {
              "undefined" == typeof t && (t = !0),
                "undefined" == typeof a &&
                  (a = r.params.newMessagesFirst ? "prepend" : "append");
              var n,
                i = "";
              for (n = 0; n < e.length; n++) {
                ...
                (s.type = s.type || "sent"),
                  s.text &&
                    ...
                    t && (s.position = "append" === a ? "bottom" : "top"),
                    (i += r.template(s)));
              }
              var o, l;
              "prepend" === a &&
                ((o = r.pageContent[0].scrollHeight),
                (l = r.pageContent[0].scrollTop)),
                r.container[a](i),
                r.params.autoLayout && r.layout(),
                "prepend" === a &&
                  (r.pageContent[0].scrollTop =
                    l + (r.pageContent[0].scrollHeight - o)),
                (("append" === a && !r.params.newMessagesFirst) ||
                  ("prepend" === a && r.params.newMessagesFirst)) &&
                  r.scrollMessages(t ? void 0 : 0);
              var p = r.container.find(".message");
              if (1 === e.length)
                return "append" === a ? p[p.length - 1] : p[0];
              var d = [];
              if ("append" === a)
            ...
            (r.removeMessage = function(e) {
              return (
                ...
                0 === e.length
                  ? !1
                  : (e.remove(), r.params.autoLayout && r.layout(), !0)
              );
            }),
            ...
            (r.init = function() {
              r.params.messages
                ...
                : (r.params.autoLayout && r.layout(), r.scrollMessages(0));
            }),
            (r.destroy = function() {
              r = null;
            }),
    ...
    (i.messages = function(e, a) {
      ...
      (i.initSwipeout = function(e) {
        ...
        function t(e) {
          if (r) {
            ...
            if (
              ("undefined" == typeof l &&
                (l = !!(l || Math.abs(t - O.y) > Math.abs(a - O.x))),
              l)
            )
              return void (r = !1);
            if (!s) {
            ...
            var n, p, E;
            if (((e.f7PreventPanelSwipe = !0), i.params.swipeoutNoFollow))
              return (
                b
                  ? ("right" === w && d > 0 && i.swipeoutClose(c),
                    "left" === w && 0 > d && i.swipeoutClose(c))
                  : (0 > d && m.length > 0 && i.swipeoutOpen(c, "right"),
                    d > 0 && f.length > 0 && i.swipeoutOpen(c, "left")),
                (r = !1),
                void (s = !1)
              );
            (P = !1), (S = !1);
            ...
            if (m.length > 0)
              for (
                ...
                "undefined" == typeof y[n]._buttonOffset &&
                  ...
                  (D = o(y[n])),
                  k.length > 0 &&
                    D.hasClass("swipeout-overswipe") &&
                    (D.css({ left: (S ? -p : 0) + "px" }),
                    S
                      ? D.addClass("swipeout-overswipe-active")
                      : D.removeClass("swipeout-overswipe-active")),
                  D.transform(
                    "translate3d(" + (v - p * (1 + Math.max(E, -1))) + "px,0,0)"
                  );
            if (f.length > 0)
              for (
                E = v / h,
                  v > h &&
                    ((v = h + Math.pow(v - h, 0.8)), T.length > 0 && (P = !0)),
                  n = 0;
                n < C.length;
                n++
              )
                "undefined" == typeof C[n]._buttonOffset &&
                  (C[n]._buttonOffset = h - C[n].offsetLeft - C[n].offsetWidth),
                  (p = C[n]._buttonOffset),
                  (D = o(C[n])),
                  T.length > 0 &&
                    D.hasClass("swipeout-overswipe") &&
                    ...
                    P
                      ? D.addClass("swipeout-overswipe-active")
                      : D.removeClass("swipeout-overswipe-active")),
                  C.length > 1 && D.css("z-index", C.length - n),
                  D.transform(
                    "translate3d(" + (v + p * (1 - Math.min(E, 1))) + "px,0,0)"
                  );
        ...
        function n(e) {
          ...
          if (
            ...
            var O = "to-left" === x ? -t : t;
            if (
              (u.transform("translate3d(" + O + "px,0,0)"),
              n.addClass("swipeout-actions-opened"),
              (l = "to-left" === x ? y : C))
            )
              for (w = 0; w < l.length; w++)
                o(l[w]).transform("translate3d(" + O + "px,0,0)");
          ...
          if (C && C.length > 0 && C !== l)
            for (w = 0; w < C.length; w++)
              (E = C[w]._buttonOffset),
                "undefined" == typeof E &&
                  (C[w]._buttonOffset = h - C[w].offsetLeft - C[w].offsetWidth),
        ...
        o(document).on(i.touchEvents.start, function(e) {
          if (i.swipeoutOpenedEl) {
            ...
            i.swipeoutOpenedEl.is(a[0]) ||
              ...
              a.parents(".actions-modal.modal-in, .modal.modal-in").length >
                0 ||
          ...
          e
            ...
            : (o(document).on(
              ...
              o(document).on(i.touchEvents.move, ".list-block li.swipeout", t),
              o(document).on(i.touchEvents.end, ".list-block li.swipeout", n));
      }),
      (i.swipeoutOpen = function(e, a, t) {
        if (
          ...
          0 !== e.length &&
            (e.length > 1 && (e = o(e[0])),
            e.hasClass("swipeout") && !e.hasClass("swipeout-opened")))
        ) {
          a ||
            (a =
              e.find(".swipeout-actions-right").length > 0 ? "right" : "left");
          var n = e.find(".swipeout-actions-" + a);
          if (0 !== n.length) {
            n.hasClass("swipeout-actions-no-fold") ||
              i.params.swipeoutActionsNoFold;
            e
              .trigger("open")
            ...
            if (s.length > 1) {
              for (r = 0; r < s.length; r++)
                "right" === a
                  ? o(s[r]).transform(
                      "translate3d(" + -s[r].offsetLeft + "px,0,0)"
                    )
                  : o(s[r])
                      .css("z-index", s.length - r)
                      .transform(
                        "translate3d(" +
                          (l - s[r].offsetWidth - s[r].offsetLeft) +
                          "px,0,0)"
                      );
              s[1].clientLeft;
            }
            for (e.addClass("transitioning"), r = 0; r < s.length; r++)
        ...
        if (((e = o(e)), 0 !== e.length && e.hasClass("swipeout-opened"))) {
          var n = e
            ...
            r = e
              ...
              .removeClass("swipeout-actions-opened"),
            s =
              (r.hasClass("swipeout-actions-no-fold") ||
                i.params.swipeoutActionsNoFold,
              r.children("a")),
            l = r.outerWidth();
          (i.allowSwipeout = !1),
          ...
          for (var d = 0; d < s.length; d++)
            "right" === n
              ? o(s[d]).transform("translate3d(" + -s[d].offsetLeft + "px,0,0)")
              : o(s[d]).transform(
                  "translate3d(" +
        ...
        function a(e) {
          if (n && p) {
            ...
            r ||
              ...
              (u = p[0].offsetTop),
              (m = p.parent().height() - p[0].offsetTop - p.height()),
              (d = p[0].offsetHeight)),
              (r = !0),
              e.preventDefault(),
              ...
              c.each(function() {
                ...
                if (e[0] !== p[0]) {
                  ...
                  r >= a - n / 2 && p.index() < e.index()
                    ? (e.transform("translate3d(0, " + -d + "px,0)"),
                      (f = e),
                      (h = void 0))
                    : a + n / 2 >= r && p.index() > e.index()
                    ? (e.transform("translate3d(0, " + d + "px,0)"),
                      (f = void 0),
                      h || (h = e))
                    : o(this).transform("translate3d(0, 0%,0)");
                }
              });
          }
        }
        function t(e) {
          ...
          f && (p.insertAfter(f), p.trigger("sort")),
            ...
            (f || h) &&
              ...
              (s = h ? h[0].f7VirtualListIndex : f[0].f7VirtualListIndex),
              a && a.moveItem(t, s)),
            (f = h = void 0),
            (n = !1),
            (r = !1);
              ...
              if (0 !== a.length) {
                ...
                if (0 !== t.length) {
                  for (var n = [], r = 0; r < t.length; r++)
                    t[r].selected && n.push(t[r].textContent.trim());
                  var i = e.find(".item-after");
                  if (0 === i.length)
                    e.find(".item-inner").append(
                      '<div class="item-after">' + n.join(", ") + "</div>"
                    );
                  else {
                    var s = i.text();
                    if (i.hasClass("smart-select-value"))
                      for (r = 0; r < t.length; r++)
                        t[r].selected = t[r].textContent.trim() === s.trim();
                    else i.text(n.join(", "));
                  }
                }
              }
      ...
      (i.smartSelectAddOption = function(e, a, t) {
        ...
        var r = n.find("select").attr("name"),
          s =
            o('.page.smart-select-page[data-select-name="' + r + '"]').length >
            0;
      ...
      (i.smartSelectOpen = function(e, a) {
        ...
        function n(a) {
          var t = !0;
          (a.target === e[0] || o(a.target).parents(e[0]).length > 0) &&
            (t = !1),
            o(a.target).parents(".picker-modal").length > 0 && (t = !1),
            t && i.closeModal(".smart-select-picker.modal-in");
        }
        function r(e) {
          k.selectedOptions.length >= Y
        ...
        function s(a) {
          if (((a = o(a)), C)) {
            ...
            a.once(
              "popup" === c || "picker" === c ? "closed" : "pageBeforeRemove",
              function() {
          ...
          Y && r(a),
            a.on("change", 'input[name="' + F + '"]', function() {
              var t = this,
                n = t.value,
                s = [];
              if ("checkbox" === t.type) {
                for (var o = 0; o < k.options.length; o++) {
                  var l = k.options[o];
                  l.value === n && (l.selected = t.checked),
                    l.selected && s.push(l.textContent.trim());
                }
                Y && r(a);
              } else (s = [e.find('option[value="' + n + '"]').text()]), (k.value = n);
              P.trigger("change"),
                e.find(".item-after").text(s.join(", ")),
                g &&
                  "radio" === q &&
                  ("popup" === c
                    ? i.closeModal(ne)
        ...
        if (((e = o(e)), 0 !== e.length)) {
          ...
          if (0 !== d.length) {
            ...
            if ("popup" === c) {
              ...
              if (o(".picker-modal.modal-in").length > 0 && !a) {
                if (
                  ...
                  o(".picker-modal.modal-in:not(.modal-out)")[0]
                )
                  return;
            ...
            var g =
              ...
              S = P.dataset();
            if (
              !(k.disabled || e.hasClass("disabled") || P.hasClass("disabled"))
            ) {
              for (
                var M,
                  I,
                ...
                (M = o(k[j])),
                  (H = M.dataset()),
                  (O = H.optionImage || S.optionImage || m.optionImage),
                  (E = H.optionIcon || S.optionIcon || m.optionIcon),
                  (I = O || E || "checkbox" === q),
                  x && (I = O || E),
                  (z = H.optionColor),
                  (A = H.optionClass),
                  M[0].disabled && (A += " disabled"),
                  (D = M.parent("optgroup")[0]),
                  (L = D && D.label),
                  (B = !1),
                  D &&
                    D !== N &&
                    ((B = !0), (N = D), R.push({ groupLabel: L, isLabel: B })),
                  R.push({
                    value: M[0].value,
              ...
              i._compiledTemplates.smartSelectItem ||
                (i._compiledTemplates.smartSelectItem = l.compile(
              ...
              "picker" === c
                ? (i._compiledTemplates.smartSelectToolbar ||
                    (i._compiledTemplates.smartSelectToolbar = l.compile(
                      i.params.smartSelectToolbarTemplate ||
                        '<div class="toolbar {{#if toolbarTheme}}theme-{{toolbarTheme}}{{/if}}"><div class="toolbar-inner"><div class="left"></div><div class="right"><a href="#" class="link close-picker"><span>{{closeText}}</span></a></div></div></div>'
                    )),
                ...
                : (i._compiledTemplates.smartSelectNavbar ||
                    (i._compiledTemplates.smartSelectNavbar = l.compile(
                      i.params.smartSelectNavbarTemplate ||
                        '<div class="navbar {{#if navbarTheme}}theme-{{navbarTheme}}{{/if}}"><div class="navbar-inner">{{leftTemplate}}<div class="center sliding">{{pageTitle}}</div></div></div>'
                    )),
                  (U = i._compiledTemplates.smartSelectNavbar({
                    ...
                    leftTemplate:
                      "popup" === c
                        ? (
                            i.params.smartSelectPopupCloseTemplate ||
                            (x
                        ...
                        : (
                            i.params.smartSelectBackTemplate ||
                            (x
                  ...
                  "page" === c
                    ? ((J = "static"),
                      e.parents(".navbar-through").length > 0 &&
                        (J = "through"),
                      e.parents(".navbar-fixed").length > 0 && (J = "fixed"),
                      (Z = e.parents(".page").hasClass("no-toolbar")
                        ? "no-toolbar"
                        : ""),
                      (K = e.parents(".page").hasClass("no-navbar")
                        ? "no-navbar"
                        : "navbar-" + J))
                    : (J = "fixed"));
              var $,
                ...
                te =
                  "undefined" == typeof e.data("searchbar")
                    ...
                    : !1;
              te &&
                (($ = e.data("searchbar-placeholder") || "Search"),
                (ee = e.data("searchbar-cancel") || "Cancel"));
              var ne,
                re,
                ie =
                  '<form class="searchbar searchbar-init" data-search-list=".smart-select-list-' +
                  V +
                  '" data-search-in=".item-title"><div class="searchbar-input"><input type="search" placeholder="' +
                  $ +
                  '"><a href="#" class="searchbar-clear"></a></div>' +
                  (x
                    ? ""
                    : '<a href="#" class="searchbar-cancel">' + ee + "</a>") +
                  '</form><div class="searchbar-overlay"></div>',
                se =
                  ("picker" !== c && "through" === J ? U : "") +
                  '<div class="pages">  <div data-page="' +
                  ae +
                  '" data-select-name="' +
                  G +
              ...
              "popup" === c
                ? (a
                    ? ((ne = o(".popup.smart-select-popup .view")), ne.html(se))
                    : ((ne = i.popup(
                      ...
                      (ne = o(ne))),
                  i.initPage(ne.find(".page")),
                  s(ne))
                : "picker" === c
                ? (a
                    ? ((re = o(".picker-modal.smart-select-picker .view")),
                      re.html(se))
                    : ((re = i.pickerModal(
                        '<div class="picker-modal smart-select-picker smart-select-picker-' +
                          ...
                          ">" +
                          Q +
                          '<div class="picker-modal-inner"><div class="view">' +
                          se +
                          "</div></div></div>"
                      )),
                      (re = o(re)),
                      t(),
                      o("html").on("click", n),
                      re.once("close", function() {
                        (e[0].f7SmartSelectPicker = void 0),
                          o("html").off("click", n),
                          e.parents(".page-content").css({ paddingBottom: "" });
                      }),
                      (e[0].f7SmartSelectPicker = re[0])),
                  i.initPage(re.find(".page")),
                  s(re))
                : (o(document).once("pageInit", ".smart-select-page", p),
                  d.router.load({ content: se, reload: a ? !0 : void 0 }));
            }
          }
        }
      });
    var g = function(e, a) {
      ...
      "undefined" != typeof r.params.updatableScroll
        ...
        : ((s = !0),
          i.device.ios && i.device.osVersion.split(".")[0] < 8 && (s = !1)),
      ...
      return (
        (r.setListSize = function() {
          ...
          if (((p = r.pageContent[0].offsetHeight), g)) {
            ...
            (f = (e.length * r.params.height) / r.params.cols),
          ...
          if (
            ...
            if (g) {
              ...
              for (h = p, u = 0; u < r.heights.length; u++)
                (f = r.heights[u]),
                  "undefined" == typeof n &&
                    (v + f >= t - 2 * p * r.params.dynamicHeightBufferSize
                      ? (n = u)
                      : (l += f)),
                  "undefined" == typeof i &&
                    ((v + f >= t + 2 * p * r.params.dynamicHeightBufferSize ||
              ...
              (n = (parseInt(t / r.params.height) - c) * r.params.cols),
                0 > n && (n = 0),
            ...
            for (var w = n; i > w; w++) {
              ...
              (y = r.items.indexOf(o[w])),
                ...
                r.domCache[y]
                  ? (C = r.domCache[y])
                  : (r.template
                      ? (r.tempDomElement.innerHTML = r.template(o[w], {
                          index: y
                        }))
                      : r.params.renderItem
                      ? (r.tempDomElement.innerHTML = r.params.renderItem(
                          y,
                          o[w]
                        ))
            ...
            s ||
              (g
                ...
                : (r.ul[0].style.height =
                    (w * r.params.height) / r.params.cols + "px")),
        ...
        (r.scrollToItem = function(e) {
          ...
          return (
            ...
            r.render(
              !0,
              a + t - parseInt(r.pageContent.css("padding-top"), 10)
            ),
            !0
          );
        }),
          ...
          for (var a, t = 0, n = 0; n < e.length; n++) {
            ...
            if (
              (r.filteredItems &&
                ...
                r.filteredItems.splice(r.filteredItems.indexOf(s), 1),
              r.params.cache)
            ) {
              var o = {};
    ...
    (i.virtualList = function(e, a) {
      ...
      (i.initPullToRefresh = function(e) {
            ...
            if ("touchmove" === e.type) {
              if (p && e.touches)
                for (var r = 0; r < e.touches.length; r++)
                  e.touches[r].identifier === p && (n = e.touches[r]);
              n || (n = e.targetTouches[0]), (a = n.pageX), (t = n.pageY);
            } else (a = e.pageX), (t = e.pageY);
            if (a && t) {
              if (
                ("undefined" == typeof u &&
                  (u = !!(u || Math.abs(t - x.y) > Math.abs(a - x.x))),
                !u)
              )
                return void (d = !1);
              if (
                ...
                if ((h.removeClass("transitioning"), v > h[0].offsetHeight))
                  return void (d = !1);
                C &&
                  ((w = h.attr("data-ptr-distance")),
                  w.indexOf("%") >= 0 &&
                    (w = (h[0].offsetHeight * parseInt(w, 10)) / 100)),
                  (P = h.hasClass("refreshing") ? w : 0),
                  (k =
                    h[0].scrollHeight === h[0].offsetHeight ||
                    "ios" !== i.device.os
                      ? !0
                      : !1);
              }
              return (
                ...
                (m > 0 && 0 >= v) || 0 > v
                  ? ("ios" === i.device.os &&
                      parseInt(i.device.osVersion.split(".")[0], 10) > 7 &&
                      0 === v &&
                      !b &&
                      (k = !0),
                    k &&
                      (e.preventDefault(),
                      (g = Math.pow(m, 0.85) + P),
                      h.transform("translate3d(0," + g + "px,0)")),
                    (k && Math.pow(m, 0.85) > w) || (!k && m >= 2 * w)
                      ? ((T = !0),
                        h.addClass("pull-up").removeClass("pull-down"))
                      : ((T = !1),
                        h.removeClass("pull-up").addClass("pull-down")),
                    y || (h.trigger("pullstart"), (y = !0)),
                    h.trigger("pullmove", {
                      event: e,
                      scrollTop: v,
                      translate: g,
        ...
        if (
          ...
          (S.find(".navbar").length > 0 ||
            S.parents(".navbar-fixed, .navbar-through").length > 0 ||
            ...
            0 !== S.length &&
              ((l[0].f7DestroyPullToRefresh = r), S.on("pageBeforeRemove", s));
        }
      }),
      ...
      (i.initPageInfiniteScroll = function(e) {
        ...
        0 !== t.length &&
          (i.attachInfiniteScroll(t), e.on("pageBeforeRemove", a));
      }),
        ...
        function a(a) {
          e.hasClass("page-on-left") ||
            ...
            w
              ...
              : (C =
                  u > m
                    ? i.params.showBarsOnPageScrollTop || 44 >= m
                      ? "show"
                      : "hide"
                    : m > 44
                    ? "hide"
          ...
          if (n || r || s) {
            ...
            if (0 !== l.length) {
              ...
              s &&
                ((p = l.find(".tabbar")),
                0 === p.length &&
                  (p = l.parents("." + i.params.viewsClass).find(".tabbar")));
              var u,
                m,
                f = d.length > 0,
                h = c.length > 0,
      ...
      (i.materialTabbarSetHighlight = function(e, a) {
        ...
        e.hasClass("tabbar-scrollable")
          ? ((t = a[0].offsetWidth + "px"),
            (n = (i.rtl ? -a[0].offsetLeft : a[0].offsetLeft) + "px"))
      ...
      (i.initPageMaterialTabbar = function(e) {
        ...
        t.length > 0 &&
          ...
          e.once("pageBeforeRemove", function() {
      ...
      (i.showTab = function(e, a, t) {
        var n = o(e);
        if (
          (2 === arguments.length && "boolean" == typeof a && (t = a),
          0 === n.length)
        )
          return !1;
        ...
        var p,
          d = r.parent().hasClass("tabs-swipeable-wrap");
        d &&
          ((p = r.parent()[0].swiper),
          p.activeIndex !== n.index() && p.slideTo(n.index(), void 0, !1));
        var c = r.children(".tab.active").removeClass("active");
        if (
          (n.addClass("active"),
          n.trigger("show"),
          !s && !d && n.find(".navbar").length > 0)
        ) {
          var u;
          (u = n.hasClass(i.params.viewClass)
            ? n[0]
            : n.parents("." + i.params.viewClass)[0]),
            i.sizeNavbars(u);
        }
        if (
          (a
          ...
          if (a && a.length > 0 && (a.addClass("active"), i.params.material)) {
            ...
            h.length > 0 &&
              (0 === h.find(".tab-link-highlight").length &&
                h
                  .find(".toolbar-inner")
                  .append('<span class="tab-link-highlight"></span>'),
              i.materialTabbarSetHighlight(h, a));
          }
      ...
      (i.initFastClicks = function() {
        ...
        function c(a) {
          e(a.target).addClass("active-state"),
            ...
            i.params.material &&
              ...
              ((S = a.pageX), (M = a.pageY), v(a.target, a.pageX, a.pageY));
        }
        function u(e) {
          o(".active-state").removeClass("active-state"),
        ...
        function h(e, a, t) {
          var n = t[0].getBoundingClientRect(),
            ...
            i = n.height,
            s = n.width,
            l = Math.max(Math.pow(Math.pow(i, 2) + Math.pow(s, 2), 0.5), 48);
          (F = o(
        ...
        function w() {
          F
            ? g()
            : Y && !N
            ? (clearTimeout(j), h(S, M, Y), setTimeout(g, 0))
            : g();
        }
        function C(e) {
        ...
        function y(r) {
          if (((N = !1), (z = !1), r.targetTouches.length > 1))
            return H && n(), !0;
          if (
            (r.touches.length > 1 && H && n(),
            i.params.tapHold &&
              (A && clearTimeout(A),
              (A = setTimeout(function() {
          ...
          if (i.device.ios) {
            ...
            if (
              ...
              (!p.isCollapsed || document.activeElement === p.focusNode)
            )
              return (D = !0), !0;
            D = !1;
          }
          i.device.android && s(r.target) && document.activeElement.blur(),
            (E = !0),
            (O = r.target),
            (I = new Date().getTime()),
              ...
              o(O)
                ...
                .each(function() {
                  ...
                  e.scrollHeight > e.offsetHeight &&
                    !L &&
                    ((L = e), (L.f7ScrollTop = L.scrollTop));
                })),
            r.timeStamp - B < i.params.fastClicksDelayBetweenClicks &&
              r.preventDefault(),
            i.params.activeState &&
              ((H = e(O)), a(H) ? (R = setTimeout(t, 80)) : t()),
            i.params.material && i.params.materialRipple && v(O, S, M);
        }
        function x(e) {
          if (E) {
            var a = !1,
            ...
            a &&
              ...
              (O = null),
              (N = !0),
              i.params.tapHold && clearTimeout(A),
              i.params.activeState && (clearTimeout(R), n()),
              i.params.material && i.params.materialRipple && b());
          }
        }
        function T(e) {
          if ((clearTimeout(R), clearTimeout(A), !E))
            return (
              !D &&
                V &&
          ...
          if (
            (D || e.preventDefault(),
            e.timeStamp - B < i.params.fastClicksDelayBetweenClicks)
          )
            return setTimeout(n, 0), !0;
          if (
            ((B = e.timeStamp),
            (E = !1),
            i.device.ios && L && L.scrollTop !== L.f7ScrollTop)
          )
            return !1;
          if (
          ...
          return E
            ...
            : (O || r(e.target) || (a = !0),
              ...
              a ||
                ...
                e.stopPropagation(),
                O ? (d(O) || N) && e.preventDefault() : e.preventDefault(),
                (O = null)),
              (q = setTimeout(
                function() {
                  V = !1;
                },
                i.device.ios || i.device.androidChrome ? 100 : 400
              )),
              i.params.tapHold &&
                (A = setTimeout(
                  function() {
      ...
      (i.initClickEvents = function() {
          ...
          if (!n) {
              ...
              (r = s.parents(".page-content")),
                0 === r.length &&
                  (s.parents(".page").length > 0 &&
                    (r = s.parents(".page").find(".page-content")),
                  0 === r.length &&
            ...
            i.params.scrollTopOnStatusbarClick &&
              ...
              r &&
                r.length > 0 &&
                (r.hasClass("tab") &&
                  (r = r.parent(".tabs").children(".page-content.active")),
        ...
        function a(e) {
          ...
          a.hasClass("open-popup") &&
            ...
            a.hasClass("close-popup") &&
              ((d = r.popup ? r.popup : ".popup.modal-in"), i.closeModal(d));
          var c;
          if (
            (a.hasClass("open-login-screen") &&
              ((c = r.loginScreen ? r.loginScreen : ".login-screen"),
              i.loginScreen(c)),
            ...
            u.length > 0
              ...
              : ((u = o(".popover.modal-in .picker-modal")),
                u.length > 0 && i.closeModal(u.parents(".popover")));
          }
            ...
            if (r.confirm) {
              ...
              g
                ? i.confirm(
                    ...
                    function() {
                      r.closeOnCancel &&
                        i.swipeoutClose(a.parents(".swipeout"));
                    }
                  )
                : i.confirm(
                    h,
          ...
          if (
            (a.hasClass("toggle-sortable") && i.sortableToggle(r.sortable),
            a.hasClass("open-sortable") && i.sortableOpen(r.sortable),
            a.hasClass("close-sortable") && i.sortableClose(r.sortable),
          ...
          if (
            (i.params.material &&
              ...
              a.hasClass("close-speed-dial") &&
                o(".speed-dial-opened").removeClass("speed-dial-opened")),
              ...
              if (
                (r.view
                  ...
                  : ((C =
                      ...
                      a.parents("." + i.params.viewClass)[0].f7View),
                    C &&
                      C.params.linksView &&
                      ("string" == typeof C.params.linksView
                        ? (C = o(C.params.linksView)[0].f7View)
                        : C.params.linksView instanceof p &&
        ...
        o(document).on(
          ...
          (i.params.scrollTopOnNavbarClick ||
            i.params.scrollTopOnStatusbarClick) &&
            o(document).on("click", ".statusbar-overlay, .navbar .center", e),
          i.support.touch &&
            !i.device.android &&
            o(document).on(
      ...
      (i.formDeleteData = function(e) {
        i.formsData[e] && ((i.formsData[e] = ""), delete i.formsData[e]),
          i.ls["f7form-" + e] &&
            ((i.ls["f7form-" + e] = ""), i.ls.removeItem("f7form-" + e));
      }),
      ...
      (i.formToJSON = function(e) {
        ...
        return (
          ...
          e.trigger("formToJSON", { formData: a }),
          a
        );
      }),
      ...
      (i.pushStateClearQueue = function() {
        if (0 !== i.pushStateQueue.length) {
          ...
          i.params.pushStateNoAnimation === !0 && (e = !1),
            "back" === a.action && i.router.back(a.view, { animatePages: e }),
            "loadPage" === a.action &&
      ...
      (i.initPushState = function() {
        function e(e) {
          if (!a) {
            ...
            if (t) {
              ...
              if (
                (n ||
                  (n = { viewIndex: i.views.indexOf(t), url: t.history[0] }),
                !(n.viewIndex < 0))
              ) {
                var r,
                  ...
                  o !== s.url &&
                    (s.history.indexOf(o) >= 0
                      ? s.allowPageChange
                        ...
                        : i.pushStateQueue.push({ action: "back", view: s })
                      : l
                      ? s.allowPageChange
                        ? i.router.load(s, {
                            content: l,
        ...
        var a;
        i.params.pushStatePreventOnLoad &&
          ((a = !0),
      ...
      (i.initPageSwiper = function(e) {
        ...
        0 !== t.length &&
          t.each(function() {
            var e = o(this);
            e.hasClass("tabs-swipeable-wrap") &&
              e
            ...
            var t;
            (t = e.data("swiper") ? JSON.parse(e.data("swiper")) : e.dataset()),
              e.hasClass("tabs-swipeable-wrap") &&
    ...
    var v = function(e) {
      ...
      var r =
        ...
        s =
          ...
          '<div class="photo-browser-slide photo-browser-slide-lazy swiper-slide"><div class="preloader {{@root.preloaderColorClass}}">{{#if @root.material}}{{@root.materialPreloaderHtml}}{{/if}}</div><span class="photo-browser-zoom-container"><img data-src="{{js "this.url || this"}}" class="swiper-lazy"></span></div>',
        p =
        ...
        m = l.compile(
          '<div class="photo-browser photo-browser-{{theme}}"><div class="view navbar-fixed toolbar-fixed">{{#unless material}}{{#if navbar}}' +
            c +
            '{{/if}}{{/unless}}<div class="page no-toolbar {{#unless navbar}}no-navbar{{/unless}} toolbar-fixed navbar-fixed" data-page="photo-browser-slides">{{#if material}}{{#if navbar}}' +
            c +
            "{{/if}}{{/if}}{{#if toolbar}}" +
            u +
            '{{/if}}<div class="photo-browser-captions photo-browser-captions-{{js "this.captionsTheme || this.theme"}}">{{#each photos}}{{#if caption}}' +
            d +
            "{{/if}}{{/each}}</div><div class=\"photo-browser-swiper-container swiper-container\"><div class=\"photo-browser-swiper-wrapper swiper-wrapper\">{{#each photos}}{{#js_compare \"this.html || ((typeof this === 'string' || this instanceof String) && (this.indexOf('<') >= 0 || this.indexOf('>') >= 0))\"}}" +
            p +
            "{{else}}{{#if @root.lazyLoading}}" +
            s +
            "{{else}}" +
            r +
            "{{/if}}{{/js_compare}}{{/each}}</div></div></div></div></div>"
        )(a.params);
      (a.activeIndex = a.params.initialSlide),
        ...
        (a.open = function(e) {
          return (
            ...
            a.opened && a.swiper
              ...
              : ((a.opened = !0),
                (a.openIndex = e),
                "standalone" === a.params.type && o("body").append(m),
                "popup" === a.params.type &&
                  ((a.popup = i.popup(
                    '<div class="popup photo-browser-popup">' + m + "</div>"
                  )),
                  o(a.popup).on("closed", a.onPopupClose)),
                "page" === a.params.type
                  ? (o(document).on("pageBeforeInit", a.onPageBeforeInit),
                    o(document).on("pageBeforeRemove", a.onPageBeforeRemove),
                    a.params.view || (a.params.view = i.mainView),
                    void a.params.view.loadContent(m))
                  : (a.layout(a.openIndex),
                    void (a.params.onOpen && a.params.onOpen(a))))
          );
        }),
        (a.close = function() {
          (a.opened = !1),
            a.swiperContainer &&
              ...
              a.swiper.destroy(),
              (a.swiper = a.swiperContainer = a.swiperWrapper = a.slides = f = h = g = void 0));
        }),
        ...
        (a.onSliderTransitionStart = function(e) {
          ...
          if (
            ...
            o(".photo-browser-prev, .photo-browser-next").removeClass(
              "photo-browser-link-inactive"
            ),
            e.isBeginning &&
              !a.params.loop &&
              o(".photo-browser-prev").addClass("photo-browser-link-inactive"),
            e.isEnd &&
              !a.params.loop &&
              o(".photo-browser-next").addClass("photo-browser-link-inactive"),
            a.captions.length > 0)
          ) {
            a.captionsContainer
            ...
            var r = a.params.loop
              ? e.slides.eq(e.activeIndex).attr("data-swiper-slide-index")
              : a.activeIndex;
            a.captionsContainer
        ...
        (a.onSliderTransitionEnd = function(e) {
          a.params.zoom &&
            ...
            (h.transform("translate3d(0,0,0) scale(1)"),
            g.transform("translate3d(0,0,0)"),
            (f = h = g = void 0),
            (v = b = 1)),
        ...
        (a.layout = function(e) {
          "page" === a.params.type
            ? (a.container = o(".photo-browser-swiper-container").parents(
                ".view"
              ))
        ...
        (a.toggleExposition = function() {
          a.container && a.container.toggleClass("photo-browser-exposed"),
            a.params.expositionHideCaptions &&
              a.captionsContainer.toggleClass("photo-browser-captions-exposed"),
            (a.exposed = !a.exposed);
        }),
        (a.enableExposition = function() {
          a.container && a.container.addClass("photo-browser-exposed"),
            a.params.expositionHideCaptions &&
              a.captionsContainer.addClass("photo-browser-captions-exposed"),
            (a.exposed = !0);
        }),
        (a.disableExposition = function() {
          a.container && a.container.removeClass("photo-browser-exposed"),
            a.params.expositionHideCaptions &&
              a.captionsContainer.removeClass("photo-browser-captions-exposed"),
            (a.exposed = !1);
        });
      var f,
        h,
      ...
      (a.onSlideGestureStart = function(e) {
        return (f && f.length) ||
          ((f = o(this)),
          0 === f.length && (f = a.swiper.slides.eq(a.swiper.activeIndex)),
          (h = f.find("img, svg, canvas")),
          (g = h.parent(".photo-browser-zoom-container")),
          0 !== g.length)
          ? (h.transition(0), void (w = !0))
          : void (h = void 0);
      }),
        (a.onSlideGestureChange = function(e) {
          h &&
            ...
            v > a.params.maxZoom &&
              (v =
                a.params.maxZoom - 1 + Math.pow(v - a.params.maxZoom + 1, 0.5)),
            v < a.params.minZoom &&
              (v =
                a.params.minZoom + 1 - Math.pow(a.params.minZoom - v + 1, 0.5)),
            h.transform("translate3d(0,0,0) scale(" + v + ")"));
        }),
        (a.onSlideGestureEnd = function(e) {
          h &&
            0 !== h.length &&
            ((v = Math.max(Math.min(v, a.params.maxZoom), a.params.minZoom)),
            h
        ...
        (a.toggleZoom = function(e) {
          if (
            (f ||
              ((f = a.swiper.slides.eq(a.swiper.activeIndex)),
              (h = f.find("img, svg, canvas")),
              (g = h.parent(".photo-browser-zoom-container"))),
            h && 0 !== h.length)
          ) {
            var t, n, r, i, s, o, l, p, d, c, u, m, w, C, y, x;
            "undefined" == typeof H.x && e
              ? ((t =
              ...
              v && 1 !== v
                ? ((v = b = 1),
                  g.transition(300).transform("translate3d(0,0,0)"),
                  h.transition(300).transform("translate3d(0,0,0) scale(1)"),
                  (f = void 0))
                : ((v = b = a.params.maxZoom),
                  e
                    ? ((r = a.container.offset().left),
                      (i = a.container.offset().top),
                      (s = r + a.container[0].offsetWidth / 2 - t),
                      (o = i + a.container[0].offsetHeight / 2 - n),
                      (d = h[0].offsetWidth),
                      (c = h[0].offsetHeight),
                      (u = d * v),
                      (m = c * v),
                      (w = Math.min(a.swiper.width / 2 - u / 2, 0)),
                      (C = Math.min(a.swiper.height / 2 - m / 2, 0)),
                      (y = -w),
                      (x = -C),
                      (l = s * v),
                      (p = o * v),
                  ...
                  g
                    .transition(300)
                    .transform("translate3d(" + l + "px, " + p + "px,0)"),
                  h
                    .transition(300)
                    .transform("translate3d(0,0,0) scale(" + v + ")"));
          }
      ...
      (a.onSlideTouchStart = function(e) {
        h &&
          0 !== h.length &&
          (C ||
            ("android" === i.device.os && e.preventDefault(),
            (C = !0),
            (H.x =
              "touchstart" === e.type ? e.targetTouches[0].pageX : e.pageX),
            (H.y =
        ...
        (a.onSlideTouchMove = function(e) {
          if (h && 0 !== h.length && ((a.swiper.allowClick = !1), C && f)) {
            y ||
              ((I = h[0].offsetWidth),
              (O = h[0].offsetHeight),
              (E = o.getTranslate(g[0], "x") || 0),
              (D = o.getTranslate(g[0], "y") || 0),
              g.transition(0));
            var t = I * v,
              n = O * v;
            if (!(t < a.swiper.width && n < a.swiper.height)) {
              if (
                ((k = Math.min(a.swiper.width / 2 - t / 2, 0)),
                (S = -k),
                (P = Math.min(a.swiper.height / 2 - n / 2, 0)),
                (M = -P),
                (R.x =
                  "touchmove" === e.type ? e.targetTouches[0].pageX : e.pageX),
                (R.y =
                ...
                !y &&
                  !w &&
                  ((Math.floor(k) === Math.floor(E) && R.x < H.x) ||
                    (Math.floor(S) === Math.floor(E) && R.x > H.x)))
              )
                return void (C = !1);
              e.preventDefault(),
                e.stopPropagation(),
                ...
                (x = R.x - H.x + E),
                (T = R.y - H.y + D),
                k > x && (x = k + 1 - Math.pow(k - x + 1, 0.8)),
                x > S && (x = S - 1 + Math.pow(x - S + 1, 0.8)),
                P > T && (T = P + 1 - Math.pow(P - T + 1, 0.8)),
                T > M && (T = M - 1 + Math.pow(T - M + 1, 0.8)),
                L || (L = R.x),
                z || (z = R.y),
                B || (B = Date.now()),
                (N = (R.x - L) / (Date.now() - B) / 2),
        ...
        (a.onSlideTouchEnd = function(e) {
          if (h && 0 !== h.length) {
            ...
            (k = Math.min(a.swiper.width / 2 - p / 2, 0)),
              (S = -k),
              (P = Math.min(a.swiper.height / 2 - d / 2, 0)),
              (M = -P),
              (x = Math.max(Math.min(x, S), k)),
              (T = Math.max(Math.min(T, M), P)),
              g
                .transition(l)
      ...
      return (
        ...
        (a.swipeCloseTouchMove = function(e, t) {
          if (j) {
            X ||
              ((X = !0),
              (q = "touchmove" === t.type ? t.targetTouches[0].pageY : t.pageY),
              (Y = a.swiper.slides.eq(a.swiper.activeIndex)),
              (G = new Date().getTime())),
              t.preventDefault(),
        ...
        (a.swipeCloseTouchEnd = function(e, t) {
          ...
          return (300 > r && n > 20) || (r >= 300 && n > 100)
            ...
            : (0 !== n
                ? Y.addClass("transitioning").transitionEnd(function() {
    ...
    var b = function(e) {
      ...
      if (!a.params.view && a.opener && a.opener.length) {
        if (((r = a.opener.parents("." + i.params.viewClass)), 0 === r.length))
          return;
        r = r[0].f7View;
      }
      if (
        !a.params.input ||
        ((a.input = o(a.params.input)),
        0 !== a.input.length || "dropdown" !== a.params.openIn)
      ) {
        ...
        if ("dropdown" !== a.params.openIn) {
          ...
          !d &&
            a.opener &&
            a.opener.length &&
            (d = a.opener.find(".item-title").text());
          var c,
            u,
            m = "autocomplete-" + a.inputName,
            f = a.params.navbarTheme,
            h = a.params.formTheme,
            g = "",
            v = "";
          (a.navbarTemplate = l.compile(
            a.params.navbarTemplate ||
            ...
            "page" === a.params.openIn
              ? ((u = "static"),
                a.opener
                  ? (a.opener.parents(".navbar-through").length > 0 &&
                      (u = "through"),
                    a.opener.parents(".navbar-fixed").length > 0 &&
                      (u = "fixed"),
                    (v = a.opener.parents(".page").hasClass("no-toolbar")
                      ? "no-toolbar"
                      : ""),
                    (g = a.opener.parents(".page").hasClass("no-navbar")
                      ? "no-navbar"
                      : "navbar-" + u))
                  : r.container &&
                    ((o(r.container).hasClass("navbar-through") ||
                      o(r.container).find(".navbar-through").length > 0) &&
                      (u = "through"),
                    (o(r.container).hasClass("navbar-fixed") ||
                      o(r.container).find(".navbar-fixed").length > 0) &&
                      (u = "fixed"),
                    (v = o(r.activePage.container).hasClass("no-toolbar")
                      ? "no-toolbar"
                      : ""),
                    (g = o(r.activePage.container).hasClass("no-navbar")
                      ? "no-navbar"
                      : "navbar-" + u)))
              : (u = "fixed");
          var b =
              '<form class="searchbar"><div class="searchbar-input"><input type="search" placeholder="' +
            ...
            w =
              ...
              " " +
              (h ? "theme-" + h : "") +
              '"><ul></ul></div><div class="list-block autocomplete-not-found"><ul><li class="item-content"><div class="item-inner"><div class="item-title">' +
              a.params.notFoundText +
              '</div></div></li></ul></div><div class="list-block autocomplete-values"><ul></ul></div></div></div></div>';
        } else
          (a.dropdownItemTemplate = l.compile(
            ...
            (a.dropdownPlaceholderTemplate = l.compile(
        ...
        return (
          ...
          (a.handleInputValue = function(e) {
            var t = a.input.val();
            a.params.source &&
              a.params.source(a, t, function(e) {
                var n = "",
                  r = a.params.limit
                    ? Math.min(a.params.limit, e.length)
                    : e.length;
                a.items = e;
                var i,
                  s = new RegExp("(" + t + ")", "i");
                for (i = 0; r > i; i++) {
                  var o =
                    "object" == typeof e[i]
                      ? e[i][a.params.valueProperty]
                      : e[i];
                  n += a.dropdownItemTemplate({
                    value: o,
                    text: ("object" != typeof e[i]
                      ? e[i]
                      : e[i][a.params.textProperty]
                    ).replace(s, "<b>$1</b>")
                  });
                }
                "" === n &&
                  ...
                  (n += a.dropdownPlaceholderTemplate({
          ...
          (a.handleDropdownClick = function(e) {
            for (var t, n = o(this), r = 0; r < a.items.length; r++) {
              var i =
                  "object" == typeof a.items[r]
                    ? a.items[r][a.params.valueProperty]
                    : a.items[r],
                s = n.attr("data-value");
              (i === s || 1 * i === 1 * s) && (t = a.items[r]);
            }
            a.params.updateInputValueOnSelect &&
              (a.input.val("object" == typeof t ? t[a.params.textProperty] : t),
              a.input.trigger("input change")),
              a.params.onChange && a.params.onChange(a, t),
              a.close();
          }),
          (a.positionDropDown = function() {
            ...
            a.dropdown.css({
              ...
              width:
                (e.length > 0 ? e[0].offsetWidth : a.input[0].offsetWidth) +
                "px"
            }),
              a.dropdown
                ...
                .css({
                  maxHeight: o + "px",
                  paddingLeft:
                    e.length > 0 && !a.params.expandInput
                      ? r.left - (s ? 16 : 15) + "px"
                      : ""
                });
          }),
          (a.pageInit = function(e) {
            function t() {
              ...
              for (e = 0; e < a.value.length; e++)
                t += a.itemTemplate({
                  value:
                    "object" == typeof a.value[e]
                      ? a.value[e][a.params.valueProperty]
                      : a.value[e],
                  text:
                    "object" == typeof a.value[e]
                      ? a.value[e][a.params.textProperty]
                      : a.value[e],
            ...
            if (n.name === m) {
              ...
              i.searchbar(l.find(".searchbar"), {
                ...
                onSearch: function(e, t) {
                  0 === t.query.length
                    ? e.overlay.addClass("searchbar-overlay-active")
                    : e.overlay.removeClass("searchbar-overlay-active");
                  var n, r;
                  a.params.source &&
                    a.params.source(a, t.query, function(e) {
                      var i = "",
                        o = a.params.limit
                          ? Math.min(a.params.limit, e.length)
                          : e.length;
                      for (a.items = e, n = 0; o > n; n++) {
                        var p = !1,
                          d =
                            "object" == typeof e[n]
                              ? e[n][a.params.valueProperty]
                              : e[n];
                        for (r = 0; r < a.value.length; r++) {
                          var c =
                            "object" == typeof a.value[r]
                              ? a.value[r][a.params.valueProperty]
                              : a.value[r];
                          (c === d || 1 * c === 1 * d) && (p = !0);
                        }
                        i += a.itemTemplate({
                      ...
                      l.find(".autocomplete-found ul").html(i),
                        0 === e.length
                          ? 0 !== t.query.length
                            ? (l.find(".autocomplete-not-found").show(),
                              l
                                .find(
                                  ".autocomplete-found, .autocomplete-values"
                                )
                                .hide())
                            : (l.find(".autocomplete-values").show(),
                              l
                                .find(
                                  ".autocomplete-found, .autocomplete-not-found"
                                )
                                .hide())
                          : (l.find(".autocomplete-found").show(),
                            l
                              .find(
                  ...
                  var e,
                    ...
                    u =
                      (o(d)
                        ...
                        .find(".item-title")
                        .text(),
                      o(d).parents(".autocomplete-values").length > 0);
                  if (u) {
                    if ("checkbox" === a.inputType && !d.checked) {
                      for (e = 0; e < a.value.length; e++)
                        (l =
                          "string" == typeof a.value[e]
                            ? a.value[e]
                            : a.value[e][a.params.valueProperty]),
                          (l === c || 1 * l === 1 * c) && a.value.splice(e, 1);
                      t(), a.params.onChange && a.params.onChange(a, a.value);
                    }
                  } else {
                    for (e = 0; e < a.items.length; e++)
                      (s =
                        "string" == typeof a.items[e]
                          ? a.items[e]
                          : a.items[e][a.params.valueProperty]),
                        (s === c || 1 * s === 1 * c) && (n = a.items[e]);
                    if ("radio" === a.inputType) a.value = [n];
                      ...
                      for (e = 0; e < a.value.length; e++)
                        (l =
                          ...
                          (l === c || 1 * l === 1 * c) && a.value.splice(e, 1);
                    t(),
                      (("radio" === a.inputType && d.checked) ||
                        "checkbox" === a.inputType) &&
                        a.params.onChange &&
                        a.params.onChange(a, a.value),
                      p &&
                        "radio" === a.inputType &&
                        ("popup" === a.params.openIn
            ...
            if (!a.opened)
              if (((a.opened = !0), "dropdown" === a.params.openIn)) {
                ...
                e.length &&
                  ...
                  o(window).on("resize", a.positionDropDown),
                  a.params.onOpen && a.params.onOpen(a);
              } else
                o(document).once("pageInit", ".autocomplete-page", a.pageInit),
                  "popup" === a.params.openIn
                    ? ((a.popup = i.popup(
            ...
            if (a.opened) {
              if ("dropdown" === a.params.openIn) {
                ...
                a.dropdown.removeClass("autocomplete-dropdown-in").remove(),
                  ...
                  (a.opened = !1),
                  o(window).off("resize", a.positionDropDown),
                  a.params.onClose && a.params.onClose(a);
              }
          ...
          (a.initEvents = function(e) {
            ...
            "dropdown" !== a.params.openIn &&
              a.opener &&
              a.opener[t]("click", a.open),
              "dropdown" === a.params.openIn &&
                a.input &&
                (a.input[t]("focus", a.open),
                a.input[t]("input", a.handleInputValue),
                a.input[t]("blur", a.close)),
              e && a.dropdown && (a.dropdown = null);
          }),
          (a.init = function() {
            a.initEvents();
          }),
    ...
    var w = function(e) {
        ...
        t() ||
          (p.input && p.input.length > 0
            ? e.target !== p.input[0] &&
              ...
              p.close()
            : 0 === o(e.target).parents(".picker-modal").length && p.close());
      }
      function l() {
        (p.opened = !1),
          p.input &&
      ...
      var p = this,
        d = {
          ...
          toolbarTemplate:
            '<div class="toolbar"><div class="toolbar-inner"><div class="left"></div><div class="right"><a href="#" class="link close-picker">{{closeText}}</a></div></div></div>'
        };
      e = e || {};
      ...
      return (
        ...
        (p.updateValue = function(e) {
          for (var a = e || [], t = [], n = 0; n < p.cols.length; n++)
            p.cols[n].divider ||
              (a.push(p.cols[n].value), t.push(p.cols[n].displayValue));
          a.indexOf(void 0) >= 0 ||
            ((p.value = a),
            (p.displayValue = t),
            p.params.onChange && p.params.onChange(p, p.value, p.displayValue),
            p.input &&
              p.input.length > 0 &&
              (o(p.input).val(
        ...
        (p.initPickerCol = function(e, a) {
          ...
          function r(e) {
            if (C) {
              ...
              (I = S + a),
                (M = void 0),
                v > I && ((I = v - Math.pow(v - I, 0.8)), (M = "min")),
                I > b && ((I = b + Math.pow(I - b, 0.8)), (M = "max")),
          ...
          function s(e) {
            ...
            (C = y = !1),
              ...
              M &&
                ("min" === M
                  ? m.wrapper.transform("translate3d(0," + v + "px,0)")
              ...
              (m.updateItems = function(e, a, t, n) {
                ...
                (n || "undefined" == typeof n) &&
                  ...
                  (m.displayValue = m.displayValues
                    ...
                    : m.value),
                  r !== e &&
                    (m.onChange && m.onChange(p, m.value, m.displayValue),
                    p.updateValue()));
              }),
          ...
          if (e.divider)
            ...
            for (var r = 0; r < e.values.length; r++)
              t +=
                ...
                e.values[r] +
                '">' +
                (e.displayValues ? e.displayValues[r] : e.values[r]) +
                "</div>";
            n +=
        ...
        !p.inline && p.params.closeByOutsideClick && o("html").on("click", s),
        (p.opened = !1),
        (p.open = function() {
          var e = a();
          p.opened ||
            ...
            e
              ? ((p.pickerHTML =
                  ...
                  p.pickerHTML +
                  "</div></div>"),
                (p.popover = i.popover(p.pickerHTML, p.params.input, !0)),
                (p.container = o(p.popover).find(".picker-modal")),
                o(p.popover).on("close", function() {
                  l();
                }))
              : p.inline
              ...
              : ((p.container = o(i.pickerModal(p.pickerHTML))),
                o(p.container).on("close", function() {
                  l();
                })),
        ...
        p.inline
          ? p.open()
          : !p.initialized && p.params.value && p.setValue(p.params.value),
        p
      );
    };
    i.picker = function(e) {
    ...
    var C = function(e) {
      ...
      function r(e) {
        if (
          (e.preventDefault(),
          !p.opened &&
            (p.open(), p.params.scrollToInput && !a() && !i.params.material))
        ) {
          var t = p.input.parents(".page-content");
          if (0 === t.length) return;
          var n,
      ...
      var p = this,
        d = {
          ...
          monthPicker: !0,
          monthPickerTemplate:
            '<div class="picker-calendar-month-picker"><a href="#" class="link icon-only picker-calendar-prev-month"><i class="icon icon-prev"></i></a><span class="current-month-value"></span><a href="#" class="link icon-only picker-calendar-next-month"><i class="icon icon-next"></i></a></div>',
          yearPicker: !0,
          yearPickerTemplate:
          ...
          headerTemplate:
            '<div class="picker-header"><div class="picker-calendar-selected-date">{{placeholder}}</div></div>',
          footerTemplate:
            '<div class="picker-footer"><a href="#" class="button close-picker">{{closeText}}</a></div>'
        };
      e = e || {};
      for (var c in d) "undefined" == typeof e[c] && (e[c] = d[c]);
      (p.params = e),
      ...
      return (
        ...
        (p.addValue = function(e) {
          if (p.params.multiple) {
            ...
            for (var a, t = 0; t < p.value.length; t++)
              new Date(e).getTime() === new Date(p.value[t]).getTime() &&
                (a = t);
            ...
            p.params.rangePicker
              ? (p.value || (p.value = []),
                (2 === p.value.length || 0 === p.value.length) &&
                  (p.value = []),
                p.value[0] !== e ? p.value.push(e) : (p.value = []),
        ...
        (p.updateValue = function(e) {
          ...
          if (
            ...
            i.params.material &&
              ...
              p.container &&
              p.container.length > 0 &&
              p.container.find(".picker-calendar-selected-date").text(t),
              p.input &&
                p.input.length > 0 &&
                !e &&
                (o(p.input).val(t), o(p.input).trigger("change"));
          }
        }),
        (p.initCalendarEvents = function() {
          ...
          function n(e) {
            if (T) {
              ...
              if (
                (0 === a.length &&
                  o(e.target).hasClass("picker-calendar-day") &&
                  (a = o(e.target)),
                0 !== a.length &&
                ...
                p.params.onDayClick && p.params.onDayClick(p, a[0], t, n, r),
                  ...
                  p.params.closeOnSelect &&
                    ((p.params.rangePicker && 2 === p.value.length) ||
                      !p.params.rangePicker) &&
                    p.close();
              }
            }
          ...
          p.container
            ...
            p.params.touchMove &&
              (p.wrapper.on(i.touchEvents.start, e),
              p.wrapper.on(i.touchEvents.move, a),
              p.wrapper.on(i.touchEvents.end, t)),
            (p.container[0].f7DestroyCalendarEvents = function() {
              p.container
                ...
                p.params.touchMove &&
                  (p.wrapper.off(i.touchEvents.start, e),
                  p.wrapper.off(i.touchEvents.move, a),
                  p.wrapper.off(i.touchEvents.end, t));
            });
        }),
          ...
          if (o.isArray(a))
              ...
              a[t].from || a[t].to
                ? a[t].from && a[t].to
                  ? e <= new Date(a[t].to).getTime() &&
                    ...
                    (n = !0)
                  : a[t].from
                  ? e >= new Date(a[t].from).getTime() && (n = !0)
                  : a[t].to && e <= new Date(a[t].to).getTime() && (n = !0)
            ...
            a.from || a.to
              ? a.from && a.to
                ...
                : a.to && e <= new Date(a.to).getTime() && (n = !0)
        ...
        (p.monthHTML = function(e, a) {
          ...
          e.getDate();
          "next" === a &&
            (e = 11 === n ? new Date(t + 1, 0) : new Date(t, n + 1, 1)),
            "prev" === a &&
              (e = 0 === n ? new Date(t - 1, 11) : new Date(t, n - 1, 1)),
            ("next" === a || "prev" === a) &&
            ...
            for (d = 1; g >= d; d++) {
              ...
              if (
                ...
                p.params.rangePicker && 2 === f.length
                  ...
                  : f.indexOf(o) >= 0 && (S += " picker-calendar-day-selected"),
                ...
                for (c = 0; c < p.params.rangesClasses.length; c++)
                  p.dateInRange(o, p.params.rangesClasses[c].range) &&
                    (S += " " + p.params.rangesClasses[c].cssClass);
              (u = !1),
                ((C && C > o) || (y && o > y)) && (u = !0),
                p.params.disabled &&
        ...
        (p.onMonthChangeEnd = function(e, a) {
          ...
          p.wrapper
            ...
            a
              ...
              : (r = p.monthHTML(new Date(p.currentYear, p.currentMonth), e)),
        ...
        (p.setYearMonth = function(e, a, t) {
          ...
          if (
            ...
            p.params.maxDate && n > new Date(p.params.maxDate).getTime())
          )
            return !1;
          if (p.params.minDate && n < new Date(p.params.minDate).getTime())
            return !1;
        ...
        (p.open = function() {
          ...
          p.opened ||
            (p.value ||
              (p.params.value && ((p.value = p.params.value), (t = !0))),
            p.layout(),
            e
              ? ((p.pickerHTML =
    ...
    (i.addNotification = function(e) {
        ...
        r.on("click", function(a) {
          ...
          e.material &&
            ...
            o(a.target).parents(".close-notification").length > 0
              ? (t = !0)
              : (e.onClick && e.onClick(a, r[0]), e.closeOnClick && (t = !0)),
      ...
      (i.closeNotification = function(e) {
        if (
          ...
          e[0].clientLeft;
          e.css("height", "0px").transition(""),
            e.data("f7NotificationOnClose") &&
              e.data("f7NotificationOnClose")(),
            0 ===
              a.find(".notification-item:not(.notification-item-removing)")
                .length && a.transform(""),
  ...
  var e = (function() {
    ...
    (e.prototype = {
          ...
          if (e.dataset) for (var n in e.dataset) t[n] = e.dataset[n];
            ...
            for (var r = 0; r < e.attributes.length; r++) {
              ...
              i.name.indexOf("data-") >= 0 &&
                (t[a.toCamelCase(i.name.split("data-")[1])] = i.value);
            }
          for (var s in t)
            "false" === t[s]
              ? (t[s] = !1)
              : "true" === t[s]
              ? (t[s] = !0)
              : parseFloat(t[s]) === 1 * t[s] && (t[s] = 1 * t[s]);
          return t;
        }
      },
      val: function(e) {
      ...
      prepend: function(a) {
        ...
        for (t = 0; t < this.length; t++)
          if ("string" == typeof a) {
            var r = document.createElement("div");
            for (r.innerHTML = a, n = r.childNodes.length - 1; n >= 0; n--)
      ...
      children: function(t) {
        for (var n = [], r = 0; r < this.length; r++)
          for (var i = this[r].childNodes, s = 0; s < i.length; s++)
            t
              ? 1 === i[s].nodeType && a(i[s]).is(t) && n.push(i[s])
      ...
      (function() {
        function t(t) {
          e.prototype[t] = function(e, n, i) {
            ...
            if ("undefined" == typeof e) {
              for (s = 0; s < this.length; s++)
                r.indexOf(t) < 0 &&
                  (t in this[s] ? this[s][t]() : a(this[s]).trigger(t));
              return this;
            }
        ...
        for (
          var n = "click blur focus focusin focusout keyup keydown keypress submit change mousedown mousemove mouseup mouseenter mouseleave mouseout mouseover touchstart touchend touchmove resize scroll".split(
              " "
            ),
    ...
    return (
      (a.ajax = function(e) {
        ...
        if (
          ("GET" === l || "HEAD" === l || "OPTIONS" === l || "DELETE" === l) &&
          e.data
        ) {
          var p;
          (p =
        ...
        return (
          (g.onload = function(a) {
              ...
              if ("json" === e.dataType)
                try {
                  (n = JSON.parse(g.responseText)),
                    r("ajaxSuccess", { xhr: g }, "success", n, g.status, g);
                } catch (i) {
                  r(
                    "ajaxError",
                    { xhr: g, parseerror: !0 },
                ...
                (n =
                  "text" === g.responseType || "" === g.responseType
                    ? g.responseText
                    : g.response),
                  r("ajaxSuccess", { xhr: g }, "success", n, g.status, g);
            ...
            e.statusCode &&
              ...
              r("ajaxComplete", { xhr: g }, "complete", g, g.status);
          }),
          (g.onerror = function(e) {
            T && clearTimeout(T),
              r("ajaxError", { xhr: g }, "error", g, g.status);
          }),
          r("ajaxStart", { xhr: g }, "start", g),
          ...
          e.timeout > 0 &&
            ...
            (T = setTimeout(function() {
              g.abort(),
                r("ajaxError", { xhr: g, timeout: !0 }, "error", g, "timeout"),
                r(
                  "ajaxComplete",
                  { xhr: g, timeout: !0 },
                  "complete",
      ...
      (a.parseUrlQuery = function(e) {
        ...
        for (e = e.split("?")[1], t = e.split("&"), a = 0; a < t.length; a++)
          (n = t[a].split("=")), (r[n[0]] = n[1]);
        return r;
      }),
          ...
          if (e.hasOwnProperty(l)) {
            ...
            if (a.isArray(e[l])) {
              ...
              for (var d = 0; d < e[l].length; d++)
                a.isArray(e[l][d]) || "object" != typeof e[l][d]
                  ? p.push(n(l) + "[]=" + r(e[l][d]))
                  : ((o = t.slice()),
                    o.push(l),
                    o.push(d + ""),
                    p.push(a.serializeObject(e[l][d], o)));
          ...
          this.each(function() {
            function s(e) {
              ...
              var t,
                ...
                d = "linear" === r ? p : 0.5 - Math.cos(p * Math.PI) / 2;
              return (
                g && (m = o + d * (c - o)),
                v && (f = l + d * (u - l)),
  ...
  (window.Dom7 = e),
    ...
    (Framework7.prototype.device = (function() {
      ...
      if (
        ((a.ios = a.android = a.iphone = a.ipad = a.androidChrome = !1),
        r &&
          ((a.os = "android"),
          (a.osVersion = r[2]),
          (a.android = !0),
        ...
        o && !s && ((a.osVersion = o[2].replace(/_/g, ".")), (a.iphone = !0)),
        ...
        a.ios &&
          ...
          (a.osVersion = t
            ...
            .split("version/")[1]
            .split(" ")[0]),
        (a.webView = (o || i || s) && t.match(/.*AppleWebKit(?!.*Safari)/i)),
        a.os && "ios" === a.os)
      ) {
      ...
      var p = n(window).width(),
        d = n(window).height();
      (a.statusBar = !1),
        a.webView && p * d === screen.width * screen.height
          ? (a.statusBar = !0)
          : (a.statusBar = !1);
      var c = [];
      if (
    ...
    (window.Template7 = (function() {
      ...
      function n(a) {
        ...
        for (n = 0; n < s.length; n++) {
          var o = s[n];
          if ("" !== o)
            if (o.indexOf("{{") < 0) i.push({ type: "plain", content: o });
            else {
      ...
      var r = function(e) {
        ...
        function i(e, a) {
          for (var t = [], n = 0; n < e.length; n++)
            0 === e[n].indexOf('"') ? t.push(e[n]) : t.push(r(e[n], a));
          return t.join(", ");
        }
        function s(e, s) {
          if (((s = s || 1), (e = e || o.template), "string" != typeof e))
              ...
              if (
                ...
                if (u.helperName in o.helpers)
                  ...
                  if (u.contextName.length > 0)
                    throw new Error(
                      'Template7: Missing helper: "' + u.helperName + '"'
                    );
                  (m = r(u.helperName, p)),
                    (d += "if (" + m + ") {"),
                    (d += "if (isArray(" + m + ")) {"),
      ...
      return (
        ...
        (i.unregisterPartial = function(e, a) {
          r.prototype.partials[e] &&
            ((r.prototype.partials[e] = void 0),
            delete r.prototype.partials[e]);
        }),
    ...
    (window.Swiper = function(t, n) {
      ...
      for (var f in n)
        if (
          ...
          (n[f].nodeType ||
            n[f] === window ||
            n[f] === document ||
            ("undefined" != typeof e && n[f] instanceof e) ||
            ("undefined" != typeof jQuery && n[f] instanceof jQuery))
        )
          m[f] = n[f];
        else {
          m[f] = {};
      ...
      for (var g in c)
        if ("undefined" == typeof n[g]) n[g] = c[g];
          ...
          for (var v in c[g])
            "undefined" == typeof n[g][v] && (n[g][v] = c[g][v]);
      var b = this;
      if (
        ((b.params = n),
        (b.originalParams = m),
        ...
        (b.container[0].swiper = b),
          ...
          "fade" === b.params.effect &&
            ...
            (b.params.watchSlidesProgress = !0),
            (b.params.spaceBetween = 0),
            "undefined" == typeof u && (b.params.virtualTranslate = !0)),
          ...
          (b.imagesToLoad = []),
          (b.imagesLoaded = 0),
          (b.loadImage = function(e, a, t, n, r) {
            function i() {
              r && r();
            }
            var s;
            ...
            b.autoplayPaused ||
              ...
              0 === e
                ...
                : b.wrapper.transitionEnd(function() {
                    b &&
                      ((b.autoplayPaused = !1),
                      b.autoplaying ? s() : b.stopAutoplay());
                  }));
          }),
              ...
              "none" !== u.css("display") &&
                ...
                b.params.centeredSlides
                  ? ((t = t + l / 2 + n / 2 + a),
                    ...
                    s % b.params.slidesPerGroup === 0 && b.snapGrid.push(t),
                    b.slidesGrid.push(t))
                  : (s % b.params.slidesPerGroup === 0 && b.snapGrid.push(t),
                    b.slidesGrid.push(t),
                    (t = t + l + a)),
          ...
          (b.updateSlidesOffset = function() {
            for (var e = 0; e < b.slides.length; e++)
              b.slides[e].swiperSlideOffset = r()
        ...
        window.navigator.pointerEnabled
          ...
          (b.touchEvents = {
            start:
              b.support.touch || !b.params.simulateTouch ? "touchstart" : w[0],
            move:
              b.support.touch || !b.params.simulateTouch ? "touchmove" : w[1],
          ...
          (b.initEvents = function(e) {
            ...
            b.browser.ie
              ? (i[r](b.touchEvents.start, b.onTouchStart, !1),
                s[r](b.touchEvents.move, b.onTouchMove, o),
                s[r](b.touchEvents.end, b.onTouchEnd, !1))
              : (b.support.touch &&
                  (i[r](b.touchEvents.start, b.onTouchStart, !1),
                  i[r](b.touchEvents.move, b.onTouchMove, o),
                  i[r](b.touchEvents.end, b.onTouchEnd, !1)),
                !n.simulateTouch ||
                  b.device.ios ||
                  b.device.android ||
                  (i[r]("mousedown", b.onTouchStart, !1),
                  document[r]("mousemove", b.onTouchMove, o),
                  document[r]("mouseup", b.onTouchEnd, !1))),
              window[r]("resize", b.onResize),
              b.params.nextButton &&
        ...
        (b.onTouchStart = function(e) {
          ...
          (b.onTouchMove = function(e) {
            if (
              (e.originalEvent && (e = e.originalEvent),
              !((B && "mousemove" === e.type) || e.preventedByNestedSwiper))
            ) {
              ...
              if (
                ...
                return (y = !0), void (b.allowClick = !1);
              if (
                (x && b.emit("onTouchMove", b, e),
                ...
                if (
                  (k && b.emit("onTouchMoveOpposite", b, e),
                  "undefined" == typeof N &&
                    b.browser.ieTouch &&
                  ...
                  if (N || !b.browser.ieTouch) {
                    ...
                    if (
                      ...
                      if (b.params.threshold > 0) {
                        if (!(Math.abs(i) > b.params.threshold || M))
                          return void (P = S);
                        if (!M)
                          return (
                            (M = !0),
          ...
          (b.onTouchEnd = function(e) {
            if (
              ...
              if (
                ...
                if (b.params.freeModeMomentum) {
                  ...
                  if (c < b.maxTranslate())
                    ...
                    b.params.freeModeMomentumBounce
                      ? (c - b.minTranslate() > f && (c = b.minTranslate() + f),
                        (u = b.minTranslate()),
                        (m = !0),
                        (O = !0))
                      : (c = b.minTranslate());
                    ...
                    (c =
                      Math.abs(b.snapGrid[h] - c) <
                        Math.abs(b.snapGrid[h - 1] - c) ||
                      "next" === b.swipeDirection
                        ? b.snapGrid[h]
                        : b.snapGrid[h - 1]),
                      b.rtl || (c = -c);
                  ...
                  if (0 !== b.velocity)
                    p = b.rtl
                      ? Math.abs((-c - b.translate) / b.velocity)
                      : Math.abs((c - b.translate) / b.velocity);
                ...
                return void (
                  (!b.params.freeModeMomentum || n >= b.params.longSwipesMs) &&
              ...
              if (n > b.params.longSwipesMs) {
                ...
                "next" === b.swipeDirection &&
                  (M >= b.params.longSwipesRatio
                    ? b.slideTo(w + b.params.slidesPerGroup)
                    : b.slideTo(w)),
                  "prev" === b.swipeDirection &&
                    (M > 1 - b.params.longSwipesRatio
                      ? b.slideTo(w + b.params.slidesPerGroup)
                      : b.slideTo(w));
              } else {
          ...
          (b.slideTo = function(e, a, t, n) {
            ...
            for (var i = 0; i < b.slidesGrid.length; i++)
              -Math.floor(100 * r) >= Math.floor(100 * b.slidesGrid[i]) &&
                (e = i);
          ...
          (b.setWrapperTranslate = function(e, a, t) {
            var n = 0,
              ...
              o = 0;
            r() ? (n = b.rtl ? -e : e) : (s = e),
              b.params.roundLengths && ((n = i(n)), (s = i(s))),
              b.params.virtualTranslate ||
                (b.support.transforms3d
                  ? b.wrapper.transform(
                      "translate3d(" + n + "px, " + s + "px, " + o + "px)"
                    )
                  : b.wrapper.transform("translate(" + n + "px, " + s + "px)")),
              (b.translate = r() ? n : s);
            var l,
          ...
          (b.createLoop = function() {
            ...
            for (
              e.each(function(t, i) {
                ...
                t < b.loopedSlides && r.push(i),
                  t < e.length && t >= e.length - b.loopedSlides && n.push(i),
            ...
            for (t = n.length - 1; t >= 0; t--)
              b.wrapper.prepend(
                a(n[t].cloneNode(!0)).addClass(b.params.slideDuplicateClass)
              );
          }),
              ...
              setTranslate: function() {
                ...
                for (var n = 0; n < b.slides.length; n++) {
                  ...
                  n % 4 === 0
                    ...
                    ? ((p = 0), (c = 4 * -o * b.size))
                    : (n - 2) % 4 === 0
                    ? ((p = b.size + 4 * o * b.size), (c = b.size))
                    : (n - 3) % 4 === 0 &&
                      ((p = -b.size), (c = 3 * b.size + 4 * b.size * o)),
                    b.rtl && (p = -p),
                    r() || ((d = p), (p = 0));
                  var u =
                    "rotateX(" +
            ...
            setTranslate: function(e, a) {
              function t(a) {
                (e =
                  ...
                  (r && "container" !== b.params.controlBy) ||
                    ...
                    (r = (e - b.minTranslate()) * n + a.minTranslate())),
              ...
              if (b.isArray(i))
                for (var s = 0; s < i.length; s++)
                  i[s] !== a && i[s] instanceof Swiper && t(i[s]);
            ...
            setTransition: function(e, a) {
              ...
              if (b.isArray(r))
                for (n = 0; n < r.length; n++)
                  r[n] !== a && r[n] instanceof Swiper && t(r[n]);
